...
pkfkbanco character(3) NOT NULL,
...
COMMENT ON COLUMN public.agencias.pkfkbanco IS 'Parte da CP [pkagencia]=[pkfkbanco,pkagencia] [composta] CE [fk1agencia]=[pkfkbanco] apontando para a tabela bancos[pkbanco]. Pode conter letras e números.';

COMMENT ON COLUMN public.agencias.pkagencia IS 'Parte da CP [pkagencia]=[pkfkbanco,pkagencia] [composta]. Pode conter letras e números.';

COMMENT ON COLUMN public.agencias.txnomeagencia IS 'Nome da Agência (sem abreviações].';

COMMENT ON COLUMN public.agencias.fklogradouro IS 'fk [fk2agencia]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está a agência bancária.';

COMMENT ON COLUMN public.agencias.txcomplemento IS 'Texto com o complemento do logradouro da agência bancária (número, andar, etc.].';
...
DROP TABLE IF EXISTS public.agenciastels CASCADE;
...
COMMENT ON COLUMN public.agenciastels.pkagenciatel IS 'pk da tabela [pkagenciatel]=[pkagenciatel]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.agenciastels.fkbanco IS 'fk [fk1agenciatel]=[fkbanco,fkagencia] [composta] apontando para a tabela agencias(pkfkbanco,pkagencia].';

COMMENT ON COLUMN public.agenciastels.fkagencia IS 'fk [fk1agenciatel]=[fkbanco,fkagencia] [composta] apontando para a tabela agencias(pkfkbanco,pkagencia].';

COMMENT ON COLUMN public.agenciastels.fkteltipo IS 'fk [fk2agenciatel]=[fkteltipo] apontando para a tabela telefonestipos(cpteltipo]';

COMMENT ON COLUMN public.agenciastels.nutelefone IS 'Número do telefone referente ao tipo na agência.';
...
DROP TABLE IF EXISTS public.aplicacoesdascontas CASCADE;

CREATE TABLE public.aplicacoesdascontas (
pknuaplicdaconta integer NOT NULL,
fkaplicfin integer NOT NULL,
fkbanco character(3) NOT NULL,
fkagencia character(6) NOT NULL,
fknuconta character(6) NOT NULL,
...
COMMENT ON COLUMN public.aplicacoesdascontas.pknuaplicdaconta IS 'pk da Tabela [pkaplicacaodaconta]=[pknuaplicdaconta]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.aplicacoesdascontas.fkaplicfin IS 'fk [fk1aplicacaodaconta]=[fkaplicfin] apontando para a tabela aplicacoesfinanceiras[pkaplicfin].';

COMMENT ON COLUMN public.aplicacoesdascontas.fkbanco IS 'fk [fk2aplicacaodaconta]=[fkbanco,fkagencia,fknuconta] [composta] apontando para a tabela contas (pkfkbanco,pkfkagencia,pknuconta] - pode ter letras.';

COMMENT ON COLUMN public.aplicacoesdascontas.fkagencia IS 'fk [fk2aplicacaodaconta]=[fkbanco,fkagencia,fknuconta] [composta] apontando para a tabela contas (pkfkbanco,pkfkagencia,pknuconta] - pode ter letras].';

COMMENT ON COLUMN public.aplicacoesdascontas.fknuconta IS 'fk [fk2aplicacaodaconta]=[fkbanco,fkagencia,fknuconta] [composta] apontando para a tabela contas (pkfkbanco,pkfkagencia,pknuconta] - pode ter letras].';
...
DROP TABLE IF EXISTS public.aplicacoesfinanceiras CASCADE;

CREATE TABLE public.aplicacoesfinanceiras (
pkaplicfin smallint NOT NULL,
...
COMMENT ON COLUMN public.aplicacoesfinanceiras.pkaplicfin IS 'pk da Tabela [pkaplicacaofinanceira]=[pkaplicfin]. Número inteiro sequencial crescente de 1 em 1.';
...
DROP TABLE IF EXISTS public.areadeestudos CASCADE;

CREATE TABLE public.areadeestudos (
...
ALTER TABLE public.areadeestudos OWNER TO postgres;

COMMENT ON TABLE public.areadeestudos IS 'Cadastro das áreas de estudo de interesse geral, tais como EXATAS, HUMANAS, etc., e suas subdivisões.			';

COMMENT ON COLUMN public.areadeestudos.pkareadeestudo IS 'pk da Tabela [pkareadeestudo]=[pkareadeestudo]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.areadeestudos.txnomearea IS 'Nome da area de estudo (ou área de conhecimento].';

COMMENT ON COLUMN public.areadeestudos.txdescricaoarea IS 'Descrição detalhada de uma Área de Estudo (ou área de conhecimento].';

COMMENT ON COLUMN public.areadeestudos.dtcadareaestudo IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.areadeestudocursos CASCADE;

CREATE TABLE public.areadeestudocursos (
pkareaestcurso integer NOT NULL,
ukcecurso integer NOT NULL,
ukceareadeestudo integer NOT NULL,
dtcadareaestcurso date NOT NULL

);

ALTER TABLE public.areadeestudocursos OWNER TO postgres;

COMMENT ON TABLE public.areadeestudocursos IS 'Registro das áreas de estudos de cada curso. É o desmembramento de um relacionamento N:M.			';

COMMENT ON COLUMN public.areadeestudocursos.pkareaestcurso IS 'pk da Tabela [pkareadeestudocurso]=[pkareaestcurso]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.areadeestudocursos.ukcecurso IS 'Parte da CC [uk1areadeestudocurso]=[ukceareadeestudo,cccecurso], CE [fk1areadeestudocurso]=[cccecurso] apontando para a tabela cursos[pkcurso].';

COMMENT ON COLUMN public.areadeestudocursos.ukceareadeestudo IS 'Parte da CC [uk1areadeestudocurso]=[ccceareadeestudo,cccecurso], CE [fk2areadeestudocurso]=[ccceareadeestudo] apontando para a tabela areadeestudos[pkareadeestudo].';

COMMENT ON COLUMN public.areadeestudocursos.dtcadareaestcurso IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.areadeestudodisciplinas CASCADE;

CREATE TABLE public.areadeestudodisciplinas (
pkareaestdisciplina integer NOT NULL,
ukcedisciplina integer NOT NULL,
ukceareadeestudo integer NOT NULL,
dtcadareaestdisc date NOT NULL

);

ALTER TABLE public.areadeestudodisciplinas OWNER TO postgres;

COMMENT ON TABLE public.areadeestudodisciplinas IS 'Registro das áreas de estudo de cada disciplina de curso. É o desmembramento de um relacionamento N:M.			';

COMMENT ON COLUMN public.areadeestudodisciplinas.pkareaestdisciplina IS 'pk da Tabela [pkareadeestudodisciplina]=[pkareaestdisciplina]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.areadeestudodisciplinas.ukcedisciplina IS 'Parte da CC [uk1areadeestudodisciplina]=[ccceareadeestudo,cccedisciplina], CE [fk1areadeestudodisciplina]=[cccedisciplina] apontando para a Tabela disciplinas[pkdisciplina].';

COMMENT ON COLUMN public.areadeestudodisciplinas.ukceareadeestudo IS 'Parte da CC [uk1areadeestudodisciplina]=[ukceareadeestudo,cccedisciplina], CE [fk2areadeestudodisciplina]=[ccceareadeestudo] apontando para a tabela areadeestudos [pkareaestudo].';

COMMENT ON COLUMN public.areadeestudodisciplinas.dtcadareaestdisc IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.areadeestudolivros CASCADE;

CREATE TABLE public.areadeestudolivros (
pkareaestlivro integer NOT NULL,
ukcelivro integer NOT NULL,
ukceareadeestudo integer NOT NULL,
nugrauinfluencia numeric,
dtcadareaestlivro date NOT NULL

);

ALTER TABLE public.areadeestudolivros OWNER TO postgres;

COMMENT ON TABLE public.areadeestudolivros IS 'Registro das áreas de estudos de cada livro. É o desmembramento de um relacionamento N:M.			';

COMMENT ON COLUMN public.areadeestudolivros.pkareaestlivro IS 'pk da Tabela [pkareadeestudolivro]=[pkareaestlivro]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.areadeestudolivros.ukcelivro IS 'Parte da CC [uk1areadeestudolivro]=[ccceareadeestudo,cccelivro], CE [fk1areadeestudolivro]=[cccelivro] apontando para a tabela livros[pklivro].';

COMMENT ON COLUMN public.areadeestudolivros.ukceareadeestudo IS 'Parte da CC [uk1areadeestudolivro]=[ukceareadeestudo,fklivro], CE [fk2areadeestudolivro]=[fkareadeestudo] apontando para tabela areadeestudos[pkareaestudo].';

COMMENT ON COLUMN public.areadeestudolivros.nugrauinfluencia IS 'Percentagem de cobertura da Área de Estudo no livro (num. inteiro]';

COMMENT ON COLUMN public.areadeestudolivros.dtcadareaestlivro IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.armazens CASCADE;
...
COMMENT ON COLUMN public.armazens.pkarmazem IS 'Pk da Tabela [pkarmazem]=[pkarmazem]. Número inteiro sequencial crescente de 1 em 1.';
...
COMMENT ON COLUMN public.armazens.fklogradouro IS 'fk [fk1armazem]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está o armazém.';
...
COMMENT ON COLUMN public.armazens.fkcliente IS 'fk [fk2armazem]=[fkcliente] apontando para a tabela cliente[pkcliente] que é dono ou aluga o armazém.';
...
DROP TABLE IF EXISTS public.armazenstels CASCADE;

CREATE TABLE public.armazenstels (
pkarmazemtel integer NOT NULL,
fkarmazem smallint NOT NULL,
fkteltipo smallint,
nutelefone character(15) NOT NULL,
txnomecontato character varying(30),
...
COMMENT ON COLUMN public.armazenstels.pkarmazemtel IS 'pk da Tabela [pkarmazemtel]=[pkarmazemtel]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.armazenstels.fkarmazem IS 'fk [fk1armazemtel]=[fkarmazem] apontando para a tabela armazens[pkarmazem].';

COMMENT ON COLUMN public.armazenstels.fkteltipo IS 'fk [fk2armazemtel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
COMMENT ON COLUMN public.atividades.pkatividade IS 'pk da Tabela [pkatividade]=[pkatividade]. Número inteiro sequencial crescente de 1 em 1.';
...
ukceprofessor smallint NOT NULL,
ukcedisciplina integer NOT NULL,
qthorasatribuidas numeric NOT NULL,
...
COMMENT ON COLUMN public.atribuicoes.pkatribuicao IS 'pk da tabela [pkatribuicao]=[pkatribuicao].';

COMMENT ON COLUMN public.atribuicoes.ukceprofessor IS 'Parte da CC [uk1atribuicao]=[ccceprofessor,cccedisciplina], CE [fk1atribuicao]=[ccceprofessor] apontando para a tabela professores[pkprofessor].';

COMMENT ON COLUMN public.atribuicoes.ukcedisciplina IS 'Parte da CC [uk1atribuicao]=[ccceprofessor,cccedisciplina], CE [fk2atribuicao]=[cccedisciplina] apontando para a tabela disciplinas[pkdisciplina].';
...
DROP TABLE IF EXISTS public.atuacoes CASCADE;

CREATE TABLE public.atuacoes (
pkatuacao smallint NOT NULL,
ukcetarefaprojeto integer NOT NULL,
ukcefuncionario smallint NOT NULL,
ukdtinicio date NOT NULL,
dttermino date,
...
COMMENT ON COLUMN public.atuacoes.pkatuacao IS 'pk da tabela [pkatuacao]=[pkatuacao]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.atuacoes.ukcetarefaprojeto IS 'Parte da CC [uk1atuacao]=[cccetarefaprojeto,cccefuncionario,ccdtinicio], CE [fk1atuacao]=[cccetarefaprojeto] apontando para a tabela tarefasprojetos[pktarefaprojeto].';

COMMENT ON COLUMN public.atuacoes.ukcefuncionario IS 'Parte da CC [uk1atuacao]=[cccetarefaprojeto,cccefuncionario,ccdtinicio], CE [fk2atuacao]=[cccefuncionario] apontando para tabela funcionarios[pkfuncionario].';

COMMENT ON COLUMN public.atuacoes.ukdtinicio IS 'Parte da CC [uk1atuacao]=[fktarefaprojeto,fkfuncionario,dtinicio], é a Data de início de atuação do Funcionário em uma tarefa de um projeto.';
...
COMMENT ON COLUMN public.autores.pkautor IS 'pk da Tabela [pkautor]=[pkautor]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.autores.txnomeautor IS 'Nome completo do autor.';

COMMENT ON COLUMN public.autores.fklogradouro IS 'fk [fk1autor]=[fklogradouro] apontando para a visão logrcompleto[pklogradouro] onde está residência do autor.';
...
DROP TABLE IF EXISTS public.autorestels CASCADE;
...
COMMENT ON COLUMN public.autorestels.pkautortel IS 'pk da Tabela [pkautortel]=[pkautortel]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.autorestels.fkautor IS 'fk [fk1autortel]=[fkautor] apontando para a tabela autores[pkautor]';

COMMENT ON COLUMN public.autorestels.fkteltipo IS 'fk [fk2autortel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo].';
...
DROP TABLE IF EXISTS public.autorias CASCADE;

CREATE TABLE public.autorias (
pkautoria integer NOT NULL,
ukcelivro integer NOT NULL,
ukceautor integer NOT NULL,
...
COMMENT ON COLUMN public.autorias.pkautoria IS 'pk da Tabela [pkautoria]=[pkautoria]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.autorias.ukcelivro IS 'Parte de uma CC composta [uk1autoria]=[fklivro,fkautor], CE [fk1autoria]=[fklivro] apontando para a tabela livros[pklivro].';

COMMENT ON COLUMN public.autorias.ukceautor IS 'Parte de uma CC composta [uk1autoria]=[fklivro,fkautor], CE [fk2autoria]=[fkautor] apontando para a tabela autores[pkautor]';
...
COMMENT ON COLUMN public.bairros.pkbairro IS 'pk da Tabela [pkbairro]=[pkbairro]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.bairros.txnomebairro IS 'Texto com o nome do bairro da cidade.';

COMMENT ON COLUMN public.bairros.fkcidade IS 'fk [fk1bairro]=[fkcidade] apontando para a tabela cidades[pkcidade] onde se localiza o bairro.';

COMMENT ON COLUMN public.bairros.dtcadbairro IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.bairroslogradouros CASCADE;
...
COMMENT ON COLUMN public.bairroslogradouros.pkbairrologradouro IS 'pk da Tabela [pkbairrologradouro]=[pkbairrologradouro]. Número sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.bairroslogradouros.fkbairro IS 'fk [fk1bairrologradouro]=[fkbairro], apontando para tabela bairros[pkbairro].';

COMMENT ON COLUMN public.bairroslogradouros.fklogradouro IS 'fk [fk2bairrologradouro]=[fklogradouro], apontando para a tabela logradouros[pklogradouro].';
...
COMMENT ON COLUMN public.bancos.pkbanco IS 'pk da Tabela [pkbanco]=[pkbanco]. Código do Banco na Federação Brasileira de Bancos.';
...
COMMENT ON COLUMN public.bancos.fklogradourosede IS 'fk [fk1banco]=[fklogradourosede] apontando para a tabela logradouros[pklogradouro] [pklogradouro] com o logradouro da sede do banco.';
...
DROP TABLE IF EXISTS public.bibliografias CASCADE;

CREATE TABLE public.bibliografias (
pkbibliografia integer NOT NULL,
ukcedisciplina smallint NOT NULL,
ukcelivro integer NOT NULL,
...
COMMENT ON TABLE public.bibliografias IS 'Registro dos livros da bilbiografia das disciplinas de um curso.É o desmembramento de um N:M. Tem a CP composta.			';

COMMENT ON COLUMN public.bibliografias.pkbibliografia IS 'pk da Tabela [pkbibliografia]=[pkbibliografia]. Número inteiro sequencial iniciando de 1.';

COMMENT ON COLUMN public.bibliografias.ukcedisciplina IS 'uk [uk1bibliografia]=[cccedisciplina,cccelivro] [composta] e CE [fk1bibliografia]=[cccedisciplina] apontando para a tabela disciplinas[pkdisciplina].';

COMMENT ON COLUMN public.bibliografias.ukcelivro IS 'uk [uk1bibliografia]=[cccedisciplina,cccelivro] [composta] e CE [fk2bibliografia]=[cccelivro] apontando para tabela livros[pklivro].';
...
COMMENT ON COLUMN public.capacitacoes.pkcapacitacao IS 'pk da Tabela [pkcapacitacao]=[pkcapacitacao]. Número inteiro sequencial iniciando de 1';

COMMENT ON COLUMN public.capacitacoes.fkcurso IS 'uk [uk1capacitacao]=[fkcurso,funcionarioce] [composta] e CE [fk1capacitacao]=[fkcurso] apontando para a tabela cursos[pkcurso].';

COMMENT ON COLUMN public.capacitacoes.fkfuncionario IS 'uk [uk1capacitacao]=[fkcurso,fkfuncionario] [composta] e CE [fk2capacitacao]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';
...
txnomecidade character varying(250),
...
COMMENT ON COLUMN public.cidades.pkcidade IS 'pk da Tabela [pkcidade]=[pkcidade].';

COMMENT ON COLUMN public.cidades.txnomecidade IS 'Nome completo da cidade';

COMMENT ON COLUMN public.cidades.fkestadodopais IS 'fk [fk1cidade]=[fkestadodopais] apontando para tabela estadosdospaises[pkestadodopais] (estados, comarcas ou condados de uma união federativa de estados].';
...
txrazaosocial character varying(250),
fklogradouro integer,
txcomplemento character varying(25),
nucep character(8) NOT NULL,
...
COMMENT ON COLUMN public.clientes.pkcliente IS 'pk da Tabela [pkcliente]=[pkcliente]';
...
COMMENT ON COLUMN public.clientes.fklogradouro IS 'fk [fk1cliente]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está a sede comercial do cliente';
...
DROP TABLE IF EXISTS public.clientestels CASCADE;

CREATE TABLE public.clientestels (
pkclientetel numeric NOT NULL,
fkcliente integer NOT NULL,
fkteltipo smallint,
nutelefone character(15) NOT NULL,
...
COMMENT ON COLUMN public.clientestels.pkclientetel IS 'pk da Tabela [pkclientetel]=[pkclientetel]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.clientestels.fkcliente IS 'fk [fk1clientetel]=[fkcliente] apontando para a tabela clientes[pkcliente]';

COMMENT ON COLUMN public.clientestels.fkteltipo IS 'fk [fk2clientetel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
COMMENT ON COLUMN public.consultas.pkconsulta IS 'pk da Tabela [pkconsulta]=[pkconsulta]. Número inteiro sequencial crescente de 1 em 1.';

COMMENT ON COLUMN public.consultas.fkfuncionario IS 'fk [fk1consulta]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';

COMMENT ON COLUMN public.consultas.fkmedico IS 'fk [fk2consulta]=[fkmedico] apontando para a tabela medicos[pkmedico].';
...
COMMENT ON COLUMN public.consultas.fkplanodesaude IS 'fk [fk3consulta]=[fkplanodesaude] apontando para a tabela planosdesaude';
...
pkfkbanco character(5) NOT NULL,
pkfkagencia character(6) NOT NULL,
...
COMMENT ON TABLE public.contas IS 'Cadastro das contas bancárias dos funcionarios. A CP desta tabela é composta: cebanco,fkagencia,idnuconta (formam a idconta].			';

COMMENT ON COLUMN public.contas.pkfkbanco IS 'pk [pkconta]=[pkfkbanco,pkfkagencia,pknuconta] [composta]. CE [fk1conta]=[pkfkbanco,pkfkagencia] [composta] apontando para a tabela agencias(pkfkbanco,pkagencia].';

COMMENT ON COLUMN public.contas.pkfkagencia IS 'pk [pkconta]=[pkfkbanco,pkfkagencia,pknuconta] [composta]. CE [fk1conta]=[pkfkbanco,pkfkagencia] [composta] apontando para a tabela agencias(pkfkbanco,pkagencia].';

COMMENT ON COLUMN public.contas.pknuconta IS 'pk [pkconta]=[pkfkbanco,pkfkagencia,pknuconta] [composta]. Sequência que identifica a conta (na agencia do banco], pode conter letras.';

COMMENT ON COLUMN public.contas.fkfuncionario IS 'fk [fk2conta]=[fkfuncionario] apontando para a tabela funcionario(cpfuncionario] que é o titular da conta.';

COMMENT ON COLUMN public.contas.vlsaldo IS 'Valor do saldo da conta atualizado a cada movimentação de valor.';

COMMENT ON COLUMN public.contas.dtcadconta IS 'Data de geração do registro.';
...
nucodhexadec character(7) NOT NULL,
...
COMMENT ON COLUMN public.cores.pkcor IS 'pk da Tabela [pkcor]=[pkcor].';

COMMENT ON COLUMN public.cores.txnomecor IS 'Nome completo da cor segundo a tabela Pantone';

COMMENT ON COLUMN public.cores.nucodhexadec IS 'Número com o Código Hexadecimal da cor.';

COMMENT ON COLUMN public.cores.dtcadcor IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.corescarros CASCADE;
...
COMMENT ON COLUMN public.corescarros.fkcarro IS 'pk [pkcorcarro]=[fkcarro,corce] [composta]. CE [fk1corcarro]=[fkcarro] apontando para a tabela veiculos[pkveiculo] (visão -> carros].';

COMMENT ON COLUMN public.corescarros.fkcor IS 'pk [pkcorcarro]=[fkcarro,fkcor] [composta]. CE [fk2corcarro]=[fkcor] apontando para a tabela cores[pkcor].';
...
COMMENT ON COLUMN public.cursos.pkcurso IS 'pk da Tabela [pkcurso]=[pkcurso]';

COMMENT ON COLUMN public.cursos.txnomecurso IS 'Nome completo (sem abreviações].';

COMMENT ON COLUMN public.cursos.fkinstituicao IS 'fk [fk1curso]=[fkinstituicao] apontando para a tabela instituicoesdeensino[pkinstituicao].';

COMMENT ON COLUMN public.cursos.qtcargahoraria IS 'Quantidade de Horas na carga horária do curso.';

COMMENT ON COLUMN public.cursos.dtcadcurso IS 'Data de geração do registro.';
...
txnomedepto character varying(90) NOT NULL,
fkfuncionariogerente smallint,
fkdeptosuperior character(3),
txlocalizacao character varying(80),
qtareatotal smallint,
dtcriacaodepto date,
...
COMMENT ON COLUMN public.departamentos.pkdepto IS 'pk da Tabela [pkdepartamento]=[pkdepto]. Sequencia de UMA letra e dois números, informados pelo usuário.';

COMMENT ON COLUMN public.departamentos.txnomedepto IS 'Nome usual completo (sem abreviações]';

COMMENT ON COLUMN public.departamentos.fkfuncionariogerente IS 'fk [fk1departamento]=[fkfuncionariogerente] apontando para a tabela funcionarios[pkfuncionario] (gerente do departamento].';

COMMENT ON COLUMN public.departamentos.fkdeptosuperior IS 'fk [fk2departamento]=[fkdeptosuperior] apontando para a tabela departamentos[pkdepto]. Código do departamento superior na empresa.';
...
DROP TABLE IF EXISTS public.departamentostels CASCADE;
...
COMMENT ON COLUMN public.departamentostels.pkdeptotel IS 'pk da Tabela [pkdeptotel]=[pkdeptotel].';

COMMENT ON COLUMN public.departamentostels.fkdepto IS 'fk [fk1deptotel]=[fkdepto] apontando para a tabela departamentos[pkdepto]';

COMMENT ON COLUMN public.departamentostels.fkteltipo IS 'fk [fk2deptotel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo].';
...
txementa character varying(250),
...
COMMENT ON COLUMN public.disciplinas.pkdisciplina IS 'Pk da Tabela [pkdisciplina]=[pkdisciplina].';

COMMENT ON COLUMN public.disciplinas.fkcurso IS 'fk [fk1disciplina]=[fkcurso] apontando para a tabela cursos[pkcurso]';
...
DROP TABLE IF EXISTS public.duplicatas CASCADE;
...
COMMENT ON COLUMN public.duplicatas.pkduplicata IS 'pk da Tabela [pkduplicata]=[pkduplicata]. Sequencial crescente positivo.';

COMMENT ON COLUMN public.duplicatas.fknunfvenda IS 'fk [fk1duplicata]=[fknunfvenda] apontando para a tabela nfvendas[pknunfvenda] da qual se gera a Duplicata.';
...
COMMENT ON COLUMN public.editoras.pkeditora IS 'pk da Tabela [pkeditora]=[pkeditora].';
...
COMMENT ON COLUMN public.editoras.fklogradouro IS 'fk [fk1editora]=[fklogradouro] apontando apontando para a tabela logradouros[pklogradouro].';
...
DROP TABLE IF EXISTS public.editorastels CASCADE;
...
COMMENT ON COLUMN public.editorastels.pkeditoratel IS 'pk da Tabela [pkeditoratel]=[pkeditoratel].';

COMMENT ON COLUMN public.editorastels.fkeditora IS 'fk [fk1editoratel]=[fkeditora] apontando para a tabela editoras[pkeditora].';

COMMENT ON COLUMN public.editorastels.fkteltipo IS 'fk [fk2editoratel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo].';
...
COMMENT ON COLUMN public.empresas.pkempresa IS 'pk da Tabela [pkempresa]=[pkempresa].';
...
COMMENT ON COLUMN public.empresas.fklogradouro IS 'fk [fk1empresa]=[fklogradouro] apontando apontando para a tabela logradouros[pklogradouro] onde está a empresa';
...
COMMENT ON COLUMN public.empresas.fksetoratuacao IS 'fk [fk2empresa]=[fksetoratuacao] apontando a tabela setoresdeatuacao[pksetoratuacao].';
...
DROP TABLE IF EXISTS public.empresastels CASCADE;
...
COMMENT ON COLUMN public.empresastels.pkempresatel IS 'pk da Tabela [pkempresatel]=[pkempresatel].';

COMMENT ON COLUMN public.empresastels.fkempresa IS 'fk [fk1empresatel]=[fkempresa] apontando para a tabela empresas[pkempresa].';

COMMENT ON COLUMN public.empresastels.fkteltipo IS 'fk [fk2empresatel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
DROP TABLE IF EXISTS public.especialidadesmedicas CASCADE;
...
COMMENT ON COLUMN public.especialidadesmedicas.pkespecialidade IS 'pk da Tabela [pkespecialidade]=[pkespecialidade].';

COMMENT ON COLUMN public.especialidadesmedicas.txnomeespecialidade IS 'Nome usual completo (sem abreviações].';

COMMENT ON COLUMN public.especialidadesmedicas.txdescrespecialidade IS 'Descrição completa das principais atribuições da especialidade (sem abreviações].';

COMMENT ON COLUMN public.especialidadesmedicas.dtcadespecmedica IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.estadosdospaises CASCADE;

CREATE TABLE public.estadosdospaises (
pkestadodopais character(3) NOT NULL,
...
COMMENT ON TABLE public.estadosdospaises IS 'Cadastro dos Estados da República Federativa do Brasil			';

COMMENT ON COLUMN public.estadosdospaises.pkestadodopais IS 'pk da Tabela [pkestadodopais]=[pkestadodopais]. Sigla do estado da união como identificado no Brasil.';
...
COMMENT ON COLUMN public.estadosdospaises.fkpais IS 'fk [fk1estadodopais]=[fkpais] apontando para tabela paises[pkpais]';

COMMENT ON COLUMN public.estadosdospaises.dtcadestadodopais IS 'Data de geração do registro.';
...
COMMENT ON COLUMN public.fabricantes.pkfabricante IS 'pk da Tabela [pkfabricante]=[pkfabricante].';
...
COMMENT ON COLUMN public.fabricantes.fklogradouro IS 'fk [fk1fabricante]=[fklogradouro] apontando apontando para a tabela logradouros[pklogradouro] onde está sede ou fábrica.';
...
COMMENT ON COLUMN public.fabricantes.fksetoratuacao IS 'fk [fk2fabricante]=[fksetoratuacao] apontando a tabela setoresdeatuacao[pksetoratuacao].';
...
DROP TABLE IF EXISTS public.fabricantestels CASCADE;
...
COMMENT ON COLUMN public.fabricantestels.pkfabricantetel IS 'pk da Tabela [pkfabricantetel]=[pkfabricantetel].';

COMMENT ON COLUMN public.fabricantestels.fkfabricante IS 'fk [fk1fabricantetel]=[fkfabricante] apontando para a tabela fabricantes[pkfabricante].';

COMMENT ON COLUMN public.fabricantestels.fkteltipo IS 'fk [fk2fabricantetel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
COMMENT ON COLUMN public.fabricantestels.dtcadfabricantetel IS 'Data de geração do registro.';
...
COMMENT ON TABLE public.faturas IS 'Cadastro das faturas que devem ser pagas pelas compras feitas por uma empresa.			';

COMMENT ON COLUMN public.faturas.pkfatura IS 'pk da Tabela [pkfatura]=[pkfatura]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.faturas.fknunfcompra IS 'fk [fk1fatura]=[fknunfcompra] apontando para a tabela nfcompras[pknunfcompra] da qual se gera a fatura..';
...
txnomefornecedor character varying(250),
txrazaosocial character varying(250),
nucnpj character(15),
fklogradouro integer,
txcomplemento character varying(25),
...
COMMENT ON COLUMN public.fornecedores.pkfornecedor IS 'pk da Tabela [pkfornecedor]=[pkfornecedor].';
...
COMMENT ON COLUMN public.fornecedores.fklogradouro IS 'fk [fk1fornecedor]=[fklogradouro] apontando apontando para a tabela logradouros[pklogradouro] onde está o Fornecedor.';
...
COMMENT ON COLUMN public.fornecedores.fksetoratuacao IS 'fk [fk2fornecedor]=[fksetoratuacao] apontando para a tabela setoresdeatuacao[pksetoratuacao](setor de atuação do fornecedor].';
...
DROP TABLE IF EXISTS public.fornecedorestels CASCADE;
...
COMMENT ON COLUMN public.fornecedorestels.pkfornecedortel IS 'pk da Tabela [pkfornecedortel]=[pkfornecedortel].';

COMMENT ON COLUMN public.fornecedorestels.fkfornecedor IS 'fk [fk1fornecedortel]=[fkfornecedor] apontando para a tabela fornecedores[pkfornecedor].';

COMMENT ON COLUMN public.fornecedorestels.fkteltipo IS 'fk [fk2fornecedortel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
DROP TABLE IF EXISTS public.fornecimentos CASCADE;

CREATE TABLE public.fornecimentos (
pkfornecimento integer NOT NULL,
ukceproduto character(12) NOT NULL,
ukcefornecedor integer NOT NULL,
...
COMMENT ON TABLE public.fornecimentos IS 'Registro com os produtos fornecidos por cada fornecedor. Lista simples atualizada sem data de referência.			';

COMMENT ON COLUMN public.fornecimentos.pkfornecimento IS 'pk da Tabela [pkfornecimento]=[pkfornecimento]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.fornecimentos.ukceproduto IS 'fk [fk1fornecimento]=[ukceproduto] apontando para a tabela produtos[pkproduto]. Forma com cccefornecedor uma UK {uk1fornecimentos=(cccefornecedor,ccprodutoce)}.';

COMMENT ON COLUMN public.fornecimentos.ukcefornecedor IS 'fk [fk2fornecimento]=[cccefornecedor] apontando para a tabela fornecedores. Forma com ccprodutoce uma UK {uk1fornecimentos=(cccefornecedor,ccprodutoce)}.';
...
dtnascimento date,
txresenha text,
vlsalario double precision,
vlbonus double precision,
vlcomissao double precision,
nucep character(8) NOT NULL,
...
COMMENT ON COLUMN public.funcionarios.pkfuncionario IS 'pk da Tabela [pkfuncionario]=[pkfuncionario].';
...
COMMENT ON COLUMN public.funcionarios.fkdepto IS 'fk [fk1funcionario]=[fkdepto] apontando para a tabelas departamentos[pkdepto].';

COMMENT ON COLUMN public.funcionarios.fkfuncao IS 'fk [fk2funcionario]=[fkfuncao] apontando para a tabela funcoes[pkfuncao].';

COMMENT ON COLUMN public.funcionarios.fkgrauescolar IS 'fk [fk3funcionario]=[fkgrauescolar] apontando para a tabela grausdeescolaridade[pkgrauescolar] com o código do nível de educação (escolaridade]';

COMMENT ON COLUMN public.funcionarios.fklogradouro IS 'fk [fk4funcionario]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está a moradia do Funcionário.';
...
DROP TABLE IF EXISTS public.funcionariosplanos CASCADE;
...
COMMENT ON COLUMN public.funcionariosplanos.pkfuncionarioplano IS 'pk da Tabela [pkfuncionarioplano]=[pkfuncionarioplano]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.funcionariosplanos.fkfuncionario IS 'fk [fk1funcionarioplano]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';

COMMENT ON COLUMN public.funcionariosplanos.fkplanodesaude IS 'fk [fk2funcionarioplano]=[fkplanodesaude] apontando para a tabela planosdesaude[pkplanodesaude]';
...
DROP TABLE IF EXISTS public.funcionariostels CASCADE;
...
COMMENT ON COLUMN public.funcionariostels.pkfuncionariotel IS 'pk da Tabela [pkfuncionariotel]=[pkfuncionariotel].';

COMMENT ON COLUMN public.funcionariostels.fkfuncionario IS 'fk [fk1funcionariotel]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';

COMMENT ON COLUMN public.funcionariostels.fkteltipo IS 'fk [fk2funcionariotel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo].';
...
COMMENT ON COLUMN public.funcoes.pkfuncao IS 'Pk da Tabela [pkfuncao]=[pkfuncao]';
...
DROP TABLE IF EXISTS public.grausdeescolaridade CASCADE;

CREATE TABLE public.grausdeescolaridade (
pkgrauescolar smallint NOT NULL,
txnomeescolaridade character varying(30) NOT NULL,
qtanosdeestudo smallint NOT NULL,
fkgrausprerequisitos smallint NOT NULL,
dtcadcegrauescolar date NOT NULL

);

ALTER TABLE public.grausdeescolaridade OWNER TO postgres;

COMMENT ON TABLE public.grausdeescolaridade IS 'Cadastro dos Graus de Escolaridade (Educação].			';

COMMENT ON COLUMN public.grausdeescolaridade.pkgrauescolar IS 'pk da Tabela [pkgraudeescolaridade]=[pkgraudeescolaridade].';

COMMENT ON COLUMN public.grausdeescolaridade.txnomeescolaridade IS 'Nome do nível de educação (sem abreviações].';
...
COMMENT ON COLUMN public.grausdeescolaridade.fkgrausprerequisitos IS 'fk [fk1grauescolar]=[fkgrausprerequisitos] apontando para a tabela grausdeescolaridade[pkgrauescolar]. CE reflexiva indicando o grau de escolaridade que deve ser anteriormente alcançado para cursar algum curso do grau de escolaridade corrente.';

COMMENT ON COLUMN public.grausdeescolaridade.dtcadcegrauescolar IS 'Data de geração do registro.';
...
COMMENT ON COLUMN public.habilitacoes.pkhabilitacao IS 'pk da Tabela [pkhabilitacao]=[pkhabilitacao]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.habilitacoes.fkcurso IS 'Parte da UK [uk1habilitacao]=[fkcurso,fkprofessor,dthabilitacao] e CE [fk1habilitacao]=[fkcurso] apontando para a tabela cursos[pkcurso].';

COMMENT ON COLUMN public.habilitacoes.fkprofessor IS 'Parte da UK [uk1habilitacao]=[fkcurso,fkprofessor,dthabilitacao] e CE [fk2habilitacao]=[fkprofessor] apontando para a tabela professores[pkprofessor].';

COMMENT ON COLUMN public.habilitacoes.dthabilitacao IS 'Parte da UK [uk1habilitacao]=[fkcurso,fkprofessor,dthabilitacao] é a Data de habilitação do professor para ministrar a disciplina.';
...
DROP TABLE IF EXISTS public.historicoprofissional CASCADE;

CREATE TABLE public.historicoprofissional (
pkhistprof smallint NOT NULL,
fkfuncionario smallint NOT NULL,
fkempresa smallint,
...
COMMENT ON COLUMN public.historicoprofissional.pkhistprof IS 'pk da Tabela [pkhistprof]=[pkhistprof]';

COMMENT ON COLUMN public.historicoprofissional.fkfuncionario IS 'fk [fk1histprof]=[fkfuncionario] apontando para tabela funcionarios[pkfuncionario]s.';

COMMENT ON COLUMN public.historicoprofissional.fkempresa IS 'fk [fk2histprof]=[fkempresa] apontando para tabela empresas[pkempresa].';

COMMENT ON COLUMN public.historicoprofissional.fkatividade IS 'fk [fk3histprof]=[fkatividade] apontando para tabela atividades[pkatividade].';
...
pkidioma smallint NOT NULL,
txnomeidioma character varying(30) NOT NULL,
txdescricaoidioma text NOT NULL,
...
COMMENT ON COLUMN public.idiomas.pkidioma IS 'pk da Tabela [pkidioma]=[pkidioma].';

COMMENT ON COLUMN public.idiomas.txnomeidioma IS 'Nome oficial do idioma reconhecido na ONU.';

COMMENT ON COLUMN public.idiomas.txdescricaoidioma IS 'Texto com descrição da estrutura do idioma. Morfologia, sintaxe principal, etc.';

COMMENT ON COLUMN public.idiomas.dtcadidioma IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.idiomasfalados CASCADE;

CREATE TABLE public.idiomasfalados (
pkidiomafalado smallint NOT NULL,
fkidioma smallint NOT NULL,
fkpais character(3) NOT NULL,
...
COMMENT ON COLUMN public.idiomasfalados.pkidiomafalado IS 'pk da Tabela [pkidiomafalado]=[pkidiomafalado].';

COMMENT ON COLUMN public.idiomasfalados.fkidioma IS 'fk [fk1idiomafalado]=[fkidioma] apontando para a tabela idiomas[pkidioma].';

COMMENT ON COLUMN public.idiomasfalados.fkpais IS 'fk [fk2idiomafalado]=[fkpais] apontando para a tabela pais[pkpais].';

COMMENT ON COLUMN public.idiomasfalados.dtcadidiomafalado IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.instituicoesdeensino CASCADE;
...
COMMENT ON COLUMN public.instituicoesdeensino.pkinstituicao IS 'pk da Tabela [pkinstituicaodeensino]=[pkinstituicaodeensino].';

COMMENT ON COLUMN public.instituicoesdeensino.txnomeinstituicao IS 'Nome usual completo (sem abreviações]';

COMMENT ON COLUMN public.instituicoesdeensino.fklogradouro IS 'fk [fk1instituicao]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está a instituição de ensino.';
...
COMMENT ON COLUMN public.instituicoesdeensino.dtcadinstensino IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.instituicoesdeensinotels CASCADE;
...
COMMENT ON COLUMN public.instituicoesdeensinotels.pkinstituicaotel IS 'pk da Tabela [pkinstituicaotel]=[pkinstituicaotel]';

COMMENT ON COLUMN public.instituicoesdeensinotels.fkinstituicao IS 'fk [fk1instituicaotel]=[fkinstituicao] apontando para a tabela instituicoesdeensino[pkinstituicao].';

COMMENT ON COLUMN public.instituicoesdeensinotels.fkteltipo IS 'fk [fk2instituicaotel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
COMMENT ON COLUMN public.instituicoesdeensinotels.dtcadinstensinotel IS 'Data de geração do registro.';
...
COMMENT ON COLUMN public.inventarios.pkinventario IS 'pk da Tabela [pkinventario]=[pkinventario]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.inventarios.ukceproduto IS 'Parte da CC [uk1inventario]=[ukceproduto,ukcefuncionario,ukdtinventario] e CE [fk1inventario]=[fkproduto] apontando para a tabela produtos[pkproduto].';

COMMENT ON COLUMN public.inventarios.ukcefuncionario IS 'Parte da CC [uk1inventario]=[ukceproduto,ukcefuncionario,ukdtinventario] e CE [fk2inventario]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';

COMMENT ON COLUMN public.inventarios.ukdtinventario IS 'Parte da CC [uk1inventario]=[ukceproduto,ukcefuncionario,ukdtinventario] é a Data de realização do inventário de estoque.';
...
fkeditora integer,
dtpublicacao date,
nuanopublicacao character(4),
qtpaginas smallint,
qtexemplares smallint,
qtexemplaresconsulta numeric,
...
COMMENT ON COLUMN public.livros.pklivro IS 'Pk da Tabela [pklivro]=[pklivro].';
...
COMMENT ON COLUMN public.livros.fkeditora IS 'fk [fk1livro]=[fkeditora] apontando para a tabela editoras[pkeditora] com o código da editora que publicou o livro.';
...
COMMENT ON COLUMN public.livros.qtexemplaresconsulta IS 'Quantidade mínima (em consulta] apontando para o livro no acervo';
...
COMMENT ON COLUMN public.logradouros.pklogradouro IS 'pk da Tabela [pklogradouro]=[pklogradouro].';
...
COMMENT ON COLUMN public.logradouros.fkcidade IS 'fk [fk1logradouro]=[fkcidade] apontando para a tabela de cidades[pkcidade].';

COMMENT ON COLUMN public.logradouros.fktipologradouro IS 'fk [fk2logradouro]=[fktipologradouro] apontando para a tabela de logradourostipos[pktipologradouro].';
...
DROP TABLE IF EXISTS public.logradourostipos CASCADE;

CREATE TABLE public.logradourostipos (
pktipologradouro smallint NOT NULL,
...
COMMENT ON COLUMN public.logradourostipos.pktipologradouro IS 'pk da Tabela [pktipologradouro]=[pktipologradouro].';
...
COMMENT ON COLUMN public.matriculas.pkmatricula IS 'pk da Tabela [pkmatricula]=[pkmatricula].';

COMMENT ON COLUMN public.matriculas.fkturma IS 'fk [fk1matricula]=[fkturma] apontando para a tabela turmas[pkturma].';

COMMENT ON COLUMN public.matriculas.fkfuncionario IS 'fk [fk2matricula]=[fkfuncionario] com o código do funcionario[pkfuncionario].';
...
fkespecialidade smallint,
fkinstituicao smallint,
fklogradouromoradia integer,
txcomplementomoradia character varying(50),
nucepmoradia character(8),
fklogradouroclinica integer,
txcomplementoclinica character varying(50),
...
COMMENT ON COLUMN public.medicos.pkmedico IS 'pk da Tabela [pkmedico]=[pkmedico].';
...
COMMENT ON COLUMN public.medicos.fkespecialidade IS 'fk [fk1medico]=[fkespecialidade] apontando para a tabela especialidadesmedicas[pkespecialidade].';

COMMENT ON COLUMN public.medicos.fkinstituicao IS 'fk [fk2medico]=[fkinstituicaodeensino] apontando para a tabela instituicoesdeensino[pkinstituicao].';

COMMENT ON COLUMN public.medicos.fklogradouromoradia IS 'fk [fk3medico]=[fklogradouromoradia] apontando apontando para a tabela logradouros[pklogradouro] com o código do Logradouro de moradia do Médico';
...
COMMENT ON COLUMN public.medicos.fklogradouroclinica IS 'fk [fk4medico]=[fklogradouroclinica] apontando para visão logrcompleto[pklogradouro]com o código do Logradouro da Clínica Principal do Médico.';
...
DROP TABLE IF EXISTS public.medicostels CASCADE;

CREATE TABLE public.medicostels (
pkmedicotel integer NOT NULL,
fkmedico integer NOT NULL,
fkteltipo smallint,
nutelefone character(15) NOT NULL,
txnomecontato character varying(30),
dtcadmedicotel date
...
COMMENT ON COLUMN public.medicostels.pkmedicotel IS 'pk da Tabela [pkmedicotel]=[pkmedicotel].';

COMMENT ON COLUMN public.medicostels.fkmedico IS 'fk [fk1medicotel]=[fkmedico] apontando para a tabela medicos[pkmedico].';

COMMENT ON COLUMN public.medicostels.fkteltipo IS 'fk [fk2medicotel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
COMMENT ON COLUMN public.movimentos.pkmovimento IS 'pk da Tabela [pkmovimento]=[pkmovimento].';

COMMENT ON COLUMN public.movimentos.fklivro IS 'fk [fk1movimento]=[fklivro] apontando para a tabela livros[pklivro] (registrado no movimento].';

COMMENT ON COLUMN public.movimentos.fkfuncionario IS 'fk [fk2movimento]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario] (que faz o movimento].';

COMMENT ON COLUMN public.movimentos.dtmovimento IS 'Data de realização do movimento';

COMMENT ON COLUMN public.movimentos.fktipomovimento IS 'fk [fk3movimento]=[fktipomovimento] apontando para a tabela movimentostipos[pktipomovimento].';
...
DROP TABLE IF EXISTS public.movimentostipos CASCADE;
...
COMMENT ON COLUMN public.movimentostipos.pktipomovimento IS 'pk da Tabela [pktipomovimento]=[pktipomovimento].';
...
DROP TABLE IF EXISTS public.nfcompras CASCADE;
...
aosituacao character(1),
txcomentarios character varying(900),
...
COMMENT ON COLUMN public.nfcompras.pknunfcompra IS 'pk da Tabela [pknunfcompra]=[pknunfcompra].';

COMMENT ON COLUMN public.nfcompras.fkfornecedor IS 'fk [fk1nunfcompra]=[fkfornecedor] apontando para a tabela fornecedores[pkfornecedor] da Nota de Compra';

COMMENT ON COLUMN public.nfcompras.fkfuncionario IS 'fk [fk2nunfcompra]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';
...
DROP TABLE IF EXISTS public.nfcomprasitens CASCADE;

CREATE TABLE public.nfcomprasitens (
fknunfcompra integer NOT NULL,
fkproduto character(12) NOT NULL,
...
COMMENT ON COLUMN public.nfcomprasitens.fknunfcompra IS 'Parte da CP [pknfcompraitem]=[fknunfcompra,fkproduto] [composta] e CE [fk1nfcompraitem]=[fknunfcompra] apontando para a tabela nfcompras[pknunfcompra] com o número da nota fiscal de compra';

COMMENT ON COLUMN public.nfcomprasitens.fkproduto IS 'Parte da CP [pknfcompraitem]=[fknunfcompra,fkproduto] [composta] e CE [fk2nfcompraitem]=[fkproduto] apontando para a tabela produtos[pkroduto].';
...
DROP TABLE IF EXISTS public.nfvendas CASCADE;
...
COMMENT ON COLUMN public.nfvendas.pknunfvenda IS 'pk da Tabela [pknunfvenda]=[pknunfvenda].';

COMMENT ON COLUMN public.nfvendas.fkcliente IS 'fk [fk1nunfvenda]=[fkcliente] apontando para a tabela clientes[pkcliente] (para o qual se faz a venda].';

COMMENT ON COLUMN public.nfvendas.fkfuncionario IS 'fk [fk2nunfvenda]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';

COMMENT ON COLUMN public.nfvendas.fkarmazem IS 'fk [fk3nunfvenda]=[fkarmazem] apontando para a tabela armazens[pkarmazem].';
...
DROP TABLE IF EXISTS public.nfvendasitens CASCADE;
...
COMMENT ON COLUMN public.nfvendasitens.fknunfvenda IS 'Parte da CP [pknfvendaitem]=[fknunfvenda,fkproduto] [composta] e CE [fk1nfvendaitem]=[fknunfvenda] apontando para a tabela nfvendas[pknunfvenda]';

COMMENT ON COLUMN public.nfvendasitens.fkproduto IS 'Parte da CP [pknfvendaitem]=[fknunfvenda,fkproduto] [composta] e CE [fk2nfvendaitem]=[idceproduto] apontando para a tabela produtos[pkroduto].';
...
COMMENT ON COLUMN public.ocorrencias.pkocorrencia IS 'pk da Tabela [pkocorrencia]=[pkocorrencia].';

COMMENT ON COLUMN public.ocorrencias.fksinistro IS 'fk [fk1ocorrencia]=[fksinistro] apontando para a tabela sinistros[pksinistro]';

COMMENT ON COLUMN public.ocorrencias.fkveiculo IS 'fk [fk2ocorrencia]=[fkveiculo] apontando para a tabela veículo[pkveiculo] que sofreu o sinistro';

COMMENT ON COLUMN public.ocorrencias.fknumeroapolice IS 'fk [fk3ocorrencia]=[fknumeroapolice]apontando para a tabela seguros[pknumeroapolice] (que cobre o sinistro do veículo].';

COMMENT ON COLUMN public.ocorrencias.fklogradouroprincipal IS 'fk [fk4ocorrencia]=[fklogradouroprincipal]apontando para a tabela logrcompleto[pklogradouro] com o código do Logradouro principal da ocorrência do sinistro.';

COMMENT ON COLUMN public.ocorrencias.fklogradourosecundario IS 'fk [fk5ocorrencia]=[fklogradourosecundario]apontando para a tabela logrcompleto[pklogradouro] com o código do Logradouro secundário da ocorrência do sinistro';
...
COMMENT ON COLUMN public.oficinas.pkoficina IS 'pk da Tabela [pkoficina]=[pkoficina].';
...
COMMENT ON COLUMN public.oficinas.fklogradouro IS 'fk [fk1oficina]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está a Oficina.';
...
DROP TABLE IF EXISTS public.oficinastels CASCADE;
...
COMMENT ON COLUMN public.oficinastels.pkoficinatel IS 'pk da Tabela [pkoficinatel]=[pkoficinatel].';

COMMENT ON COLUMN public.oficinastels.fkoficina IS 'fk [fk1oficinatel]=[fkoficina] apontando para a tabela oficinas[pkoficina].';

COMMENT ON COLUMN public.oficinastels.fkteltipo IS 'fk [fk2oficinatel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
pkpais character(1) NOT NULL,
txnomepais character varying(200),
txidiomafalado character varying(200),
...
COMMENT ON COLUMN public.paises.pkpais IS 'pk da Tabela [pkpais]=[pkpais].';
...
DROP TABLE IF EXISTS public.palavraschaves CASCADE;
...
COMMENT ON COLUMN public.palavraschaves.pkpalavra IS 'pk da Tabela [pkpalavra]=[pkpalavra].';
...
DROP TABLE IF EXISTS public.palavraslivros CASCADE;
...
COMMENT ON COLUMN public.palavraslivros.fkpalavra IS 'Parte da CP [pkpalavralivro]=[fkpalavra,fklivro] e CE [fk1palavralivro]=[fkpalavra] apontando para a tabela palavraschaves[pkpalavra].';

COMMENT ON COLUMN public.palavraslivros.fklivro IS 'Parte da CP [pkpalavralivro]=[fkpalavra,fklivro] e CE [fk2palavralivro]=[fklivro] apontando para a tabela livros[pklivro]';

COMMENT ON COLUMN public.palavraslivros.dtcadpalchavelivro IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.passagens CASCADE;
...
COMMENT ON COLUMN public.passagens.pkpassagem IS 'pk da Tabela [pkpassagem]=[pkpassagem].';

COMMENT ON COLUMN public.passagens.fkviagem IS 'fk [fk1passagem]=[fkviagem] apontando para a tabela viagens[pkviagem], com o código da viagem para o qual se vende a passagem';

COMMENT ON COLUMN public.passagens.fkonibus IS 'fk [fk2passagem]=[fkonibus] apontando para a tabela veiculos[pkveiculo], com o código do ônibus para o qual se vende a passagem';
...
COMMENT ON COLUMN public.passagens.fkfuncionario IS 'fk [fk3passagem]=[fkfuncionario] com o código do funcionário que compra a passagem.';

COMMENT ON COLUMN public.passagens.dtcadpassagem IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.pedcompras CASCADE;

CREATE TABLE public.pedcompras (
pkpedcompra integer NOT NULL,
fkfornecedor integer,
fkfuncionario smallint,
dtpedcompra date,
txcomentarios character varying(900),
...
COMMENT ON COLUMN public.pedcompras.pkpedcompra IS 'pk da Tabela [pkpedcompra]=[pkpedcompra].';

COMMENT ON COLUMN public.pedcompras.fkfornecedor IS 'fk [fk1pedcompra]=[fkfornecedor] apontando para a tabela fornecedores[pkfornecedor] (do Pedido de compra].';

COMMENT ON COLUMN public.pedcompras.fkfuncionario IS 'fk [fk2pedcompra]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario] (que emitem o Pedido de Compra].';
...
DROP TABLE IF EXISTS public.pedcomprasitens CASCADE;

CREATE TABLE public.pedcomprasitens (
pkpedcompraitem integer NOT NULL,
fkpedcompra integer NOT NULL,
fkproduto character(12) NOT NULL,
...
COMMENT ON COLUMN public.pedcomprasitens.pkpedcompraitem IS 'pk da Tabela [pkpedcompraitem]=[pkpedcompraitem].';

COMMENT ON COLUMN public.pedcomprasitens.fkpedcompra IS 'Parte da UK [uk1pedcompraitem]=[fkpedcompra,fkproduto] [composta] e CE [fk1pedcompraitem]=[fkpedcompra] apontando para a tabela pedcompras[pkpedcompra].';

COMMENT ON COLUMN public.pedcomprasitens.fkproduto IS 'Parte da UK [uk1pedcompraitem]=[fkpedcompra,fkproduto] [composta] e CE [fk2pedcompraitem]=[fkproduto] apontando para a tabela produtos[pkproduto].';
...
DROP TABLE IF EXISTS public.pedvendas CASCADE;

CREATE TABLE public.pedvendas (
pkpedvenda smallint NOT NULL,
fkcliente integer,
fkfuncionario smallint,
dtpedvenda date,
txcomentarios character varying(900),
...
COMMENT ON COLUMN public.pedvendas.pkpedvenda IS 'pk da Tabela [pkpedvenda]=[pkpedvenda].';

COMMENT ON COLUMN public.pedvendas.fkcliente IS 'fk [fk1pedvenda]=[fkcliente] apontando para a tabela clientes[pkcliente].';

COMMENT ON COLUMN public.pedvendas.fkfuncionario IS 'fk [fk2pedvenda]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario].';
...
DROP TABLE IF EXISTS public.pedvendasitens CASCADE;

CREATE TABLE public.pedvendasitens (
pkpedvendaitem smallint NOT NULL,
fkpedvenda smallint NOT NULL,
fkproduto character(12) NOT NULL,
...
COMMENT ON COLUMN public.pedvendasitens.pkpedvendaitem IS 'pk da Tabela [pkpedvendaitem]=[pkpedvendaitem].';

COMMENT ON COLUMN public.pedvendasitens.fkpedvenda IS 'Parte da UK [uk1pedvendaitem]=[fkpedvenda,fkproduto] e CE [fk1pedvendaitem]=[fkpedvenda] apontando para a tabela pedvendas[pkpedvenda]';

COMMENT ON COLUMN public.pedvendasitens.fkproduto IS 'Parte da UK [uk1pedvendaitem]=[fkpedvenda,fkproduto] e CE [fk2pedvendaitem]=[fkproduto] apontando para a tabela produtos[pkproduto].';
...
DROP TABLE IF EXISTS public.planosdesaude CASCADE;
...
COMMENT ON COLUMN public.planosdesaude.pkplanodesaude IS 'pk da Tabela [pkplanodesaude]=[pkplanodesaude].';
...
COMMENT ON COLUMN public.planosdesaude.fklogradouro IS 'fk [fk1planodesaude]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está o escritório do Plano de Saúde.';
...
COMMENT ON COLUMN public.planosdesaude.dtcadplanodesaude IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.planosdesaudemedicos CASCADE;

CREATE TABLE public.planosdesaudemedicos (
pkplanosaudemed integer NOT NULL,
fkplanodesaude integer NOT NULL,
fkmedico integer NOT NULL,
...
COMMENT ON COLUMN public.planosdesaudemedicos.pkplanosaudemed IS 'pk da Tabela [pkplanosaudemed]=[pkplanosaudemed].';

COMMENT ON COLUMN public.planosdesaudemedicos.fkplanodesaude IS 'fk [fk1planosaudemed]=[fkplanodesaude] apontando para a tabela planosdesaude[pkplanodesaude].';

COMMENT ON COLUMN public.planosdesaudemedicos.fkmedico IS 'fk [fk2planosaudemed]=[fkmedico] apontando para a tabela medicos[pkmedico].';
...
DROP TABLE IF EXISTS public.planosdesaudetels CASCADE;
...
COMMENT ON COLUMN public.planosdesaudetels.pkplanostel IS 'pk da Tabela [pkplanotel]=[pkplanostel].';

COMMENT ON COLUMN public.planosdesaudetels.fkplanodesaude IS 'fk [fk1planotel]=[fkplanodesaude] apontando para a tabela planosdesaude[pkplanodesaude]';

COMMENT ON COLUMN public.planosdesaudetels.fkteltipo IS 'fk [fk2planotel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
txnomeproduto character varying(128),
vlpreco numeric(9,2),
vlprecopromocao numeric(9,2),
vlprecominimo numeric(9,2),
qtestoque numeric(7,2),
qtdiaspromocao smallint,
txdescricaocompleta text,
...
COMMENT ON COLUMN public.produtos.pkproduto IS 'pk da Tabela [pkproduto]=[pkproduto].';
...
COMMENT ON COLUMN public.professores.pkprofessor IS 'pk da Tabela [pkprofessor]=[pkprofessor].';

COMMENT ON COLUMN public.professores.txnomeprofessor IS 'Nome completo e sem abreviações';

COMMENT ON COLUMN public.professores.fklogradouro IS 'fk [fk1professor]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está a residência do Professor.';
...
DROP TABLE IF EXISTS public.professorestels CASCADE;
...
COMMENT ON COLUMN public.professorestels.pkprofessortel IS 'pk da Tabela [pkprofessortel]=[pkprofessortel].';

COMMENT ON COLUMN public.professorestels.fkprofessor IS 'fk [fk1professortel]=[fkprofessor] apontando para a tabela professores[pkprofessor]';

COMMENT ON COLUMN public.professorestels.fkteltipo IS 'fk [fk2professortel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo]';
...
txnomeprojeto character varying(90) NOT NULL,
fkdepto character(3),
fkfuncresponsavel smallint,
vlestimado numeric,
dtinicio date,
dttermino date,
fkprojetosuperior character(6),
...
COMMENT ON COLUMN public.projetos.pkprojeto IS 'pk da Tabela [pkprojeto]=[pkprojeto].';

COMMENT ON COLUMN public.projetos.txnomeprojeto IS 'Nome completo e sem abreviações.';

COMMENT ON COLUMN public.projetos.fkdepto IS 'fk [fk1projeto]=[fkdepto] apontando para a tabela departamentos[pkdepto], com o código do departamento que lidera ou coordena o projeto';

COMMENT ON COLUMN public.projetos.fkfuncresponsavel IS 'fk [fk2projeto]=[fkfuncionarioresponsavel] apontando para a tabela funcionarios[pkfuncionario], com o código do funcionário responsável pelo projeto';
...
COMMENT ON COLUMN public.projetos.fkprojetosuperior IS 'fk [fk3projeto]=[fkprojetosuperior] apontando para a tabela projetos[pkprojeto], com o código de projeto superior (havendo subordinação].';

COMMENT ON COLUMN public.projetos.dtcadprojeto IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.rotasviarias CASCADE;

CREATE TABLE public.rotasviarias (
pkrota numeric NOT NULL,
txnomerota character varying(60) NOT NULL,
txdescrperiodo character varying(250) NOT NULL,
fkcidadeorigem smallint,
fkcidadedestino smallint,
...
COMMENT ON COLUMN public.rotasviarias.pkrota IS 'pk da Tabela [pkrota]=[pkrota].';
...
COMMENT ON COLUMN public.rotasviarias.fkcidadeorigem IS 'fk [fk1rota]=[fkcidadeorigem] apontando para a tabela cidades[pkcidade], com o código da cidade de origem da rota viária';

COMMENT ON COLUMN public.rotasviarias.fkcidadedestino IS 'fk [fk2rota]=[fkcidadedestino] apontando para a tabela cidades[pkcidade], com o código da cidade de destino da rota viária';
...
COMMENT ON TABLE public.roteiros IS 'Cadastro dos roteiros de cada Rota Viária. É a lista de cidades por onde um ônibus passa em uma rota. Pode ser conhecido como itinerário.			';

COMMENT ON COLUMN public.roteiros.pkroteiro IS 'pk da Tabela [pkroteiro]=[pkroteiro]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.roteiros.fkrota IS 'fk [fk1roteiro]=[fkrota] apontando para a tabela rotasviarias[pkrota] e parte da CP composta da Tabela.';

COMMENT ON COLUMN public.roteiros.fkcidade IS 'fk [fk2roteiro]=[fkcidade] apontando para a tabela cidades[pkcidade] e parte da CP composta da Tabela.';
...
DROP TABLE IF EXISTS public.seguradoras CASCADE;
...
COMMENT ON COLUMN public.seguradoras.pkseguradora IS 'pk da Tabela [pkseguradora]=[pkseguradora].';

COMMENT ON COLUMN public.seguradoras.txnomeseguradora IS 'Nome completo e sem abreviações.';

COMMENT ON COLUMN public.seguradoras.fklogradouro IS 'fk [fk1seguradora]=[fklogradouro] apontando para a tabela logradouros[pklogradouro] onde está a sede da seguradora.';
...
DROP TABLE IF EXISTS public.seguradorastels CASCADE;
...
COMMENT ON COLUMN public.seguradorastels.pkseguradoratel IS 'pk da Tabela [pkseguradoratel]=[pkseguradoratel].';

COMMENT ON COLUMN public.seguradorastels.fkseguradora IS 'fk [fk1seguradoratel]=[fkseguradora] apontando para a tabela seguradoras[pkseguradora].';

COMMENT ON COLUMN public.seguradorastels.fkteltipo IS 'fk [fk2seguradoratel]=[fkteltipo] apontando para a tabela telefonestipos[pkteltipo].';

COMMENT ON COLUMN public.seguradorastels.nutelefone IS 'Número do telefone (somente os números]';

COMMENT ON COLUMN public.seguradorastels.txnomecontato IS 'Texto com o nome da pessoa que atende no número de telefone indicado no registro.';
...
COMMENT ON COLUMN public.seguros.pknumeroapolice IS 'pk da Tabela [pkseguro]=[pknumeroapolice] (assumindo que as seguradoras tenham um cadastro único de apólices de seguros]';

COMMENT ON COLUMN public.seguros.fkveiculo IS 'fk [fk1seguro]=[fkveiculo] apontando para a tabela veiculos[pkveiculo], com o código do veículo (pode ser carro ou ônibus].';

COMMENT ON COLUMN public.seguros.fkseguradora IS 'fk [fk2seguro]=[fkseguradora] apontando para a tabela seguradoras[pkseguradora].';
...
COMMENT ON COLUMN public.servicos.pkservico IS 'pk da Tabela [pkservico]=[pkservico].';
...
COMMENT ON COLUMN public.servicosfeitospor.pkservicofeitopor IS 'pk da Tabela [pkservicofeitopor]=[pkservicofeitopor]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.servicosfeitospor.fkoficina IS 'fk [fk1servicofeitopor]=[fkoficina] apontando para tabela oficinas[coficina] (que realiza um serviço].';

COMMENT ON COLUMN public.servicosfeitospor.fkservico IS 'fk [fk2servicofeitopor]=[fkservico] apontando para tabela serviços[pkservico] (prestados por uma oficina].';

COMMENT ON COLUMN public.servicosfeitospor.txdescrcomplementar IS 'Descrição complementar do serviço prestado (se preciso].';
...
DROP TABLE IF EXISTS public.servicosprestados CASCADE;

CREATE TABLE public.servicosprestados (
pkservicoprestado integer NOT NULL,
fkservicofeitopor integer,
fkveiculo integer,
...
COMMENT ON COLUMN public.servicosprestados.pkservicoprestado IS 'pk da Tabela [pkservicoprestado]=[pkservicoprestado]';

COMMENT ON COLUMN public.servicosprestados.fkservicofeitopor IS 'fk [fk1servicoprestado]=[fkservicofeitopor] apontando para a tabela servicosfeitospor[pkservicofeitopor] que são feitos nos veículos (ônibus ou carros].';

COMMENT ON COLUMN public.servicosprestados.fkveiculo IS 'fk [fk2servicoprestado]=[fkveiculo] apontando para a tabela veiculos[pkveiculo], com o código do veículo (ônibus ou carros] no qual se faz um serviço.';
...
COMMENT ON COLUMN public.setoresdeatuacao.pksetoratuacao IS 'pk da Tabela [pksetoratuacao]=[pksetoratuacao].';

COMMENT ON COLUMN public.setoresdeatuacao.txnomesetordeatuacao IS 'Nome completo e sem abreviações';

COMMENT ON COLUMN public.setoresdeatuacao.txdescrsetordeatuacao IS 'Texto descrevendo o que se desenvolve no setor de atuação.';
...
COMMENT ON COLUMN public.sinistros.pksinistro IS 'pk da Tabela [pksinistro]=[pksinistro].';
...
COMMENT ON COLUMN public.tarefas.pktarefa IS 'pk da Tabela [pktarefa]=[pktarefa].';
...
DROP TABLE IF EXISTS public.tarefasprojetos CASCADE;
...
COMMENT ON COLUMN public.tarefasprojetos.pktarefaprojeto IS 'pk da Tabela [pktarefaprojeto]=[pktarefaprojeto].';

COMMENT ON COLUMN public.tarefasprojetos.fkprojeto IS 'fk [fk1tarefaprojeto]=[fkprojeto] apontando para a tabela projetos[pkprojeto] indicando o código do projeto que tem a tarefa.';

COMMENT ON COLUMN public.tarefasprojetos.fktarefa IS 'fk [fk2tarefaprojeto]=[fktarefa] apontando para a tabela tarefas[pktarefa] indicando o código da tarefa do projeto';
...
DROP TABLE IF EXISTS public.telefonestipos CASCADE;

CREATE TABLE public.telefonestipos (
pkteltipo smallint NOT NULL,
...
COMMENT ON COLUMN public.telefonestipos.pkteltipo IS 'pk da Tabela [pktipotelefone]=[pkteltipo].';

COMMENT ON COLUMN public.telefonestipos.txdescricaotipotel IS 'Texto descrevendo o tipo de telefone (sem abreviações].';

COMMENT ON COLUMN public.telefonestipos.dtcadtipotelefone IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.titulacoes CASCADE;

CREATE TABLE public.titulacoes (
pktitulacao integer NOT NULL,
fkprofessor smallint NOT NULL,
fkgrauescolar smallint NOT NULL,
fkinstituicao smallint,
...
COMMENT ON COLUMN public.titulacoes.pktitulacao IS 'pk da Tabela [pktitulacao]=[pktitulacao]. Número inteiro sequencial crescente de 5 em 5.';

COMMENT ON COLUMN public.titulacoes.fkprofessor IS 'fk [fk1titulacao]=[fkprofessor] apontando para a tabela de professores[pkprofessor].';

COMMENT ON COLUMN public.titulacoes.fkgrauescolar IS 'fk [fk2titulacao]=[pkgrauescolar] apontando para grausdeescolaridade[pkgrauescolar].';

COMMENT ON COLUMN public.titulacoes.fkinstituicao IS 'fk [fk3titulacao]=[fkinstituicao] apontando para a tabela instituicoesensino[pkinstituicao].';
...
COMMENT ON COLUMN public.turmas.pkturma IS 'pk da Tabela [pkturma]=[pkturma]. Sequencial possitivo.';

COMMENT ON COLUMN public.turmas.nuanosemestre IS 'Ano e Semestre quando a turma existe.';

COMMENT ON COLUMN public.turmas.fkatribuicao IS 'fk [fk1turma]=[fkatribuicao] apontando para a tabela atribuicoes[pkatribuicao]';
...
COMMENT ON COLUMN public.veiculos.pkveiculo IS 'pk da Tabela [pkveiculo]=[pkveiculo].';

COMMENT ON COLUMN public.veiculos.ukplaca IS 'Chave Candidata [uk1veiculo]=[ccplaca]. Placa do veículo (somente letras e números].';

COMMENT ON COLUMN public.veiculos.fktipoveiculo IS 'fk [fk1veiculo]=[fktipoveiculo] apontando para a tabela veiculotipos[pktipoveiculo] (Tipos de Veículos].';

COMMENT ON COLUMN public.veiculos.fkmodeloveiculo IS 'fk [fk2veiculo]=[fkmodeloveiculo] apontando para a tabela veiculosmodelos[pkmodeloveiculo] (Modelos de Veículos].';

COMMENT ON COLUMN public.veiculos.fkfuncionario IS 'fk [fk3veiculo]=[fkfuncionario] apontando para a tabela funcionarios[pkfuncionario] (funcionário proprietário do carro].';
...
DROP TABLE IF EXISTS public.veiculosmarcas CASCADE;

CREATE TABLE public.veiculosmarcas (
pkmarcaveiculo integer NOT NULL,
...
COMMENT ON COLUMN public.veiculosmarcas.pkmarcaveiculo IS 'pk da Tabela [pkmarcaveiculo]=[pkmarcaveiculo].';

COMMENT ON COLUMN public.veiculosmarcas.txnomemarca IS 'Nome completo e sem abreviações';

COMMENT ON COLUMN public.veiculosmarcas.fkfabricante IS 'fk [fk1marcaveiculo]=[fkfabricante] apontando para a tabela fabricantes[pkfabricante] com o código do fabricante da marca.';

COMMENT ON COLUMN public.veiculosmarcas.dtcadmarcaveiculo IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.veiculosmodelos CASCADE;

CREATE TABLE public.veiculosmodelos (
pkmodeloveiculo integer NOT NULL,
fkmarcaveiculo integer NOT NULL,
...
COMMENT ON COLUMN public.veiculosmodelos.pkmodeloveiculo IS 'pk da Tabela [pkmodeloveiculo]=[pkmodeloveiculo].';

COMMENT ON COLUMN public.veiculosmodelos.fkmarcaveiculo IS 'fk [fk1modeloveiculo]=[fkmarcaveiculo] apontando para a tabela veiculosmarcas[pkmarcaveiculo] com o código da marca de veiculos feitos por fabricantes.';
...
COMMENT ON COLUMN public.veiculosmodelos.dtcadmodeloveiculo IS 'Data de geração do registro.';


DROP TABLE IF EXISTS public.veiculostipos CASCADE;
...
COMMENT ON COLUMN public.veiculostipos.pktipoveiculo IS 'pk da Tabela [pktipoveiculo]=[pktipoveiculo].';
...
COMMENT ON COLUMN public.viagens.pkviagem IS 'pk da Tabela [pkviagem]=[pkviagem].';

COMMENT ON COLUMN public.viagens.fkrota IS 'fk [fk1viagem]=[fkrota] apontando para a tabela rotasviarias[pkrota] com o código da rota viária da viagem.';
...
ALTER TABLE ONLY public.agencias ADD CONSTRAINT agencias_pkey PRIMARY KEY (pkfkbanco, pkagencia);

ALTER TABLE ONLY public.agenciastels ADD CONSTRAINT agenciastels_pkey PRIMARY KEY (pkagenciatel);

ALTER TABLE ONLY public.aplicacoesdascontas ADD CONSTRAINT aplicacoesdascontas_pkey PRIMARY KEY (pknuaplicdaconta);

ALTER TABLE ONLY public.aplicacoesfinanceiras ADD CONSTRAINT aplicacoesfinanceiras_pkey PRIMARY KEY (pkaplicfin);

ALTER TABLE ONLY public.areadeestudos ADD CONSTRAINT areadeestudos_pkey PRIMARY KEY (pkareadeestudo);

ALTER TABLE ONLY public.areadeestudocursos ADD CONSTRAINT areadeestudocursos_pkey PRIMARY KEY (pkareaestcurso);

ALTER TABLE ONLY public.areadeestudodisciplinas ADD CONSTRAINT areadeestudodisciplinas_pkey PRIMARY KEY (pkareaestdisciplina);

ALTER TABLE ONLY public.areadeestudolivros ADD CONSTRAINT areadeestudolivros_pkey PRIMARY KEY (pkareaestlivro);

ALTER TABLE ONLY public.armazens ADD CONSTRAINT armazens_pkey PRIMARY KEY (pkarmazem);

ALTER TABLE ONLY public.armazenstels ADD CONSTRAINT armazenstels_pkey PRIMARY KEY (pkarmazemtel);

ALTER TABLE ONLY public.atividades ADD CONSTRAINT atividades_pkey PRIMARY KEY (pkatividade);

ALTER TABLE ONLY public.atribuicoes ADD CONSTRAINT atribuicoes_pkey PRIMARY KEY (pkatribuicao);

ALTER TABLE ONLY public.atuacoes ADD CONSTRAINT atuacoes_pkey PRIMARY KEY (pkatuacao);

ALTER TABLE ONLY public.autores ADD CONSTRAINT autores_pkey PRIMARY KEY (pkautor);

ALTER TABLE ONLY public.autorestels ADD CONSTRAINT autorestels_pkey PRIMARY KEY (pkautortel);

ALTER TABLE ONLY public.autorias ADD CONSTRAINT autorias_pkey PRIMARY KEY (pkautoria);

ALTER TABLE ONLY public.bairros ADD CONSTRAINT bairros_pkey PRIMARY KEY (pkbairro);

ALTER TABLE ONLY public.bairroslogradouros ADD CONSTRAINT bairroslogradouros_pkey PRIMARY KEY (pkbairrologradouro);

ALTER TABLE ONLY public.bancos ADD CONSTRAINT bancos_pkey PRIMARY KEY (pkbanco);

ALTER TABLE ONLY public.bibliografias ADD CONSTRAINT bibliografias_pkey PRIMARY KEY (pkbibliografia);

ALTER TABLE ONLY public.capacitacoes ADD CONSTRAINT capacitacoes_pkey PRIMARY KEY (pkcapacitacao);

ALTER TABLE ONLY public.cidades ADD CONSTRAINT cidades_pkey PRIMARY KEY (pkcidade);

ALTER TABLE ONLY public.clientes ADD CONSTRAINT clientes_pkey PRIMARY KEY (pkcliente);

ALTER TABLE ONLY public.clientestels ADD CONSTRAINT clientestels_pkey PRIMARY KEY (pkclientetel);

ALTER TABLE ONLY public.consultas ADD CONSTRAINT consultas_pkey PRIMARY KEY (pkconsulta);

ALTER TABLE ONLY public.contas ADD CONSTRAINT contas_pkey PRIMARY KEY (pkfkbanco, pkfkagencia, pknuconta);

ALTER TABLE ONLY public.cores ADD CONSTRAINT cores_pkey PRIMARY KEY (pkcor);

ALTER TABLE ONLY public.cursos ADD CONSTRAINT cursos_pkey PRIMARY KEY (pkcurso);

ALTER TABLE ONLY public.departamentos ADD CONSTRAINT departamentos_pkey PRIMARY KEY (pkdepto);

ALTER TABLE ONLY public.departamentostels ADD CONSTRAINT departamentostels_pkey PRIMARY KEY (pkdeptotel);

ALTER TABLE ONLY public.disciplinas ADD CONSTRAINT disciplinas_pkey PRIMARY KEY (pkdisciplina);

ALTER TABLE ONLY public.duplicatas ADD CONSTRAINT duplicatas_pkey PRIMARY KEY (pkduplicata);

ALTER TABLE ONLY public.editoras ADD CONSTRAINT editoras_pkey PRIMARY KEY (pkeditora);

ALTER TABLE ONLY public.editorastels ADD CONSTRAINT editorastels_pkey PRIMARY KEY (pkeditoratel);

ALTER TABLE ONLY public.empresas ADD CONSTRAINT empresas_pkey PRIMARY KEY (pkempresa);

ALTER TABLE ONLY public.empresastels ADD CONSTRAINT empresastels_pkey PRIMARY KEY (pkempresatel);

ALTER TABLE ONLY public.especialidadesmedicas ADD CONSTRAINT especialidadesmedicas_pkey PRIMARY KEY (pkespecialidade);

ALTER TABLE ONLY public.estadosdospaises ADD CONSTRAINT estadosdospaises_pkey PRIMARY KEY (pkestadodopais);

ALTER TABLE ONLY public.fabricantes ADD CONSTRAINT fabricantes_pkey PRIMARY KEY (pkfabricante);

ALTER TABLE ONLY public.fabricantestels ADD CONSTRAINT fabricantestels_pkey PRIMARY KEY (pkfabricantetel);

ALTER TABLE ONLY public.faturas ADD CONSTRAINT faturas_pkey PRIMARY KEY (pkfatura);

ALTER TABLE ONLY public.fornecedores ADD CONSTRAINT fornecedores_pkey PRIMARY KEY (pkfornecedor);

ALTER TABLE ONLY public.fornecedorestels ADD CONSTRAINT fornecedorestels_pkey PRIMARY KEY (pkfornecedortel);

ALTER TABLE ONLY public.fornecimentos ADD CONSTRAINT fornecimentos_pkey PRIMARY KEY (pkfornecimento);

ALTER TABLE ONLY public.funcionarios ADD CONSTRAINT funcionarios_pkey PRIMARY KEY (pkfuncionario);

ALTER TABLE ONLY public.funcionariosplanos ADD CONSTRAINT funcionariosplanos_pkey PRIMARY KEY (pkfuncionarioplano);

ALTER TABLE ONLY public.funcionariostels ADD CONSTRAINT funcionariostels_pkey PRIMARY KEY (pkfuncionariotel);

ALTER TABLE ONLY public.funcoes ADD CONSTRAINT funcoes_pkey PRIMARY KEY (pkfuncao);

ALTER TABLE ONLY public.grausdeescolaridade ADD CONSTRAINT grausdeescolaridade_pkey PRIMARY KEY (pkgrauescolar);

ALTER TABLE ONLY public.habilitacoes ADD CONSTRAINT habilitacoes_pkey PRIMARY KEY (pkhabilitacao);

ALTER TABLE ONLY public.historicoprofissional ADD CONSTRAINT historicoprofissional_pkey PRIMARY KEY (pkhistprof);

ALTER TABLE ONLY public.idiomas ADD CONSTRAINT idiomas_pkey PRIMARY KEY (pkidioma);

ALTER TABLE ONLY public.idiomasfalados ADD CONSTRAINT idiomasfalados_pkey PRIMARY KEY (pkidiomafalado);

ALTER TABLE ONLY public.instituicoesdeensino ADD CONSTRAINT instituicoesdeensino_pkey PRIMARY KEY (pkinstituicao);

ALTER TABLE ONLY public.instituicoesdeensinotels ADD CONSTRAINT instituicoesdeensinotels_pkey PRIMARY KEY (pkinstituicaotel);

ALTER TABLE ONLY public.inventarios ADD CONSTRAINT inventarios_pkey PRIMARY KEY (pkinventario);

ALTER TABLE ONLY public.livros ADD CONSTRAINT livros_pkey PRIMARY KEY (pklivro);

ALTER TABLE ONLY public.logradouros ADD CONSTRAINT logradouros_pkey PRIMARY KEY (pklogradouro);

ALTER TABLE ONLY public.logradourostipos ADD CONSTRAINT logradourostipos_pkey PRIMARY KEY (pktipologradouro);

ALTER TABLE ONLY public.matriculas ADD CONSTRAINT matriculas_pkey PRIMARY KEY (pkmatricula);

ALTER TABLE ONLY public.medicos ADD CONSTRAINT medicos_pkey PRIMARY KEY (pkmedico);

ALTER TABLE ONLY public.medicostels ADD CONSTRAINT medicostels_pkey PRIMARY KEY (pkmedicotel);

ALTER TABLE ONLY public.movimentos ADD CONSTRAINT movimentos_pkey PRIMARY KEY (pkmovimento);

ALTER TABLE ONLY public.movimentostipos ADD CONSTRAINT movimentostipos_pkey PRIMARY KEY (pktipomovimento);

ALTER TABLE ONLY public.nfcompras ADD CONSTRAINT nfcompras_pkey PRIMARY KEY (pknunfcompra);

ALTER TABLE ONLY public.nfvendas ADD CONSTRAINT nfvendas_pkey PRIMARY KEY (pknunfvenda);

ALTER TABLE ONLY public.ocorrencias ADD CONSTRAINT ocorrencias_pkey PRIMARY KEY (pkocorrencia);

ALTER TABLE ONLY public.oficinas ADD CONSTRAINT oficinas_pkey PRIMARY KEY (pkoficina);

ALTER TABLE ONLY public.oficinastels ADD CONSTRAINT oficinastels_pkey PRIMARY KEY (pkoficinatel);

ALTER TABLE ONLY public.paises ADD CONSTRAINT paises_pkey PRIMARY KEY (pkpais);

ALTER TABLE ONLY public.palavraschaves ADD CONSTRAINT palavraschaves_pkey PRIMARY KEY (pkpalavra);

ALTER TABLE ONLY public.passagens ADD CONSTRAINT passagens_pkey PRIMARY KEY (pkpassagem);

ALTER TABLE ONLY public.pedcompras ADD CONSTRAINT pedcompras_pkey PRIMARY KEY (pkpedcompra);

ALTER TABLE ONLY public.pedcomprasitens ADD CONSTRAINT pedcomprasitens_pkey PRIMARY KEY (pkpedcompraitem);

ALTER TABLE ONLY public.pedvendas ADD CONSTRAINT pedvendas_pkey PRIMARY KEY (pkpedvenda);

ALTER TABLE ONLY public.pedvendasitens ADD CONSTRAINT pedvendasitens_pkey PRIMARY KEY (pkpedvendaitem);

ALTER TABLE ONLY public.planosdesaude ADD CONSTRAINT planosdesaude_pkey PRIMARY KEY (pkplanodesaude);

ALTER TABLE ONLY public.planosdesaudemedicos ADD CONSTRAINT planosdesaudemedicos_pkey PRIMARY KEY (pkplanosaudemed);

ALTER TABLE ONLY public.planosdesaudetels ADD CONSTRAINT planosdesaudetels_pkey PRIMARY KEY (pkplanostel);

ALTER TABLE ONLY public.produtos ADD CONSTRAINT produtos_pkey PRIMARY KEY (pkproduto);

ALTER TABLE ONLY public.professores ADD CONSTRAINT professores_pkey PRIMARY KEY (pkprofessor);

ALTER TABLE ONLY public.professorestels ADD CONSTRAINT professorestels_pkey PRIMARY KEY (pkprofessortel);

ALTER TABLE ONLY public.projetos ADD CONSTRAINT projetos_pkey PRIMARY KEY (pkprojeto);

ALTER TABLE ONLY public.rotasviarias ADD CONSTRAINT rotasviarias_pkey PRIMARY KEY (pkrota);

ALTER TABLE ONLY public.roteiros ADD CONSTRAINT roteiros_pkey PRIMARY KEY (pkroteiro);

ALTER TABLE ONLY public.seguradoras ADD CONSTRAINT seguradoras_pkey PRIMARY KEY (pkseguradora);

ALTER TABLE ONLY public.seguradorastels ADD CONSTRAINT seguradorastels_pkey PRIMARY KEY (pkseguradoratel);

ALTER TABLE ONLY public.seguros ADD CONSTRAINT seguros_pkey PRIMARY KEY (pknumeroapolice);

ALTER TABLE ONLY public.servicos ADD CONSTRAINT servicos_pkey PRIMARY KEY (pkservico);

ALTER TABLE ONLY public.servicosfeitospor ADD CONSTRAINT servicosfeitospor_pkey PRIMARY KEY (pkservicofeitopor);

ALTER TABLE ONLY public.servicosprestados ADD CONSTRAINT servicosprestados_pkey PRIMARY KEY (pkservicoprestado);

ALTER TABLE ONLY public.setoresdeatuacao ADD CONSTRAINT setoresdeatuacao_pkey PRIMARY KEY (pksetoratuacao);

ALTER TABLE ONLY public.sinistros ADD CONSTRAINT sinistros_pkey PRIMARY KEY (pksinistro);

ALTER TABLE ONLY public.tarefas ADD CONSTRAINT tarefas_pkey PRIMARY KEY (pktarefa);

ALTER TABLE ONLY public.tarefasprojetos ADD CONSTRAINT tarefasprojetos_pkey PRIMARY KEY (pktarefaprojeto);

ALTER TABLE ONLY public.telefonestipos ADD CONSTRAINT telefonestipos_pkey PRIMARY KEY (pkteltipo);

ALTER TABLE ONLY public.titulacoes ADD CONSTRAINT titulacoes_pkey PRIMARY KEY (pktitulacao);

ALTER TABLE ONLY public.turmas ADD CONSTRAINT turmas_pkey PRIMARY KEY (pkturma);

ALTER TABLE ONLY public.veiculos ADD CONSTRAINT veiculos_pkey PRIMARY KEY (pkveiculo);

ALTER TABLE ONLY public.veiculosmarcas ADD CONSTRAINT veiculosmarcas_pkey PRIMARY KEY (pkmarcaveiculo);

ALTER TABLE ONLY public.veiculosmodelos ADD CONSTRAINT veiculosmodelos_pkey PRIMARY KEY (pkmodeloveiculo);

ALTER TABLE ONLY public.veiculostipos ADD CONSTRAINT veiculostipos_pkey PRIMARY KEY (pktipoveiculo);

ALTER TABLE ONLY public.viagens ADD CONSTRAINT viagens_pkey PRIMARY KEY (pkviagem);

ALTER TABLE public.areadeestudocursos ADD CONSTRAINT areadeestudocursosuk UNIQUE (ukcecurso, ukceareadeestudo);

ALTER TABLE public.areadeestudodisciplinas ADD CONSTRAINT areadeestudodisciplinasuk UNIQUE (ukcedisciplina, ukceareadeestudo);

ALTER TABLE public.areadeestudolivros ADD CONSTRAINT areadeestudolivrosuk UNIQUE (ukcelivro, ukceareadeestudo);

ALTER TABLE public.atribuicoes ADD CONSTRAINT atribuicoesuk UNIQUE (ukceprofessor, ukcedisciplina);

ALTER TABLE public.atuacoes ADD CONSTRAINT atuacoesuk UNIQUE (ukcetarefaprojeto, ukcefuncionario, ukdtinicio);

ALTER TABLE public.autorias ADD CONSTRAINT autoriasuk UNIQUE (ukcelivro, ukceautor);

ALTER TABLE public.bibliografias ADD CONSTRAINT bibliografiasuk UNIQUE (ukcedisciplina, ukcelivro);

ALTER TABLE public.fornecimentos ADD CONSTRAINT fornecimentosuk UNIQUE (ukceproduto, ukcefornecedor);

ALTER TABLE public.inventarios ADD CONSTRAINT inventariosuk UNIQUE (ukceproduto, ukcefuncionario, ukdtinventario);

ALTER TABLE public.veiculos ADD CONSTRAINT veiculosuk UNIQUE (ukplaca);

ALTER TABLE ONLY public.agencias ADD CONSTRAINT fk1agencia FOREIGN KEY (pkfkbanco) REFERENCES public.bancos(pkbanco) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT  ;

ALTER TABLE ONLY public.agencias ADD CONSTRAINT fk2agencia FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT  ;

ALTER TABLE ONLY public.agenciastels ADD CONSTRAINT fk1agenciatel FOREIGN KEY (fkbanco,fkagencia) REFERENCES public.agencias(pkfkbanco,pkagencia) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.agenciastels ADD CONSTRAINT fk2agenciatel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.aplicacoesdascontas ADD CONSTRAINT fk1aplicacaodaconta FOREIGN KEY (fkbanco,fkagencia,fknuconta) REFERENCES public.contas(pkfkbanco,pkfkagencia,pknuconta) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.aplicacoesdascontas ADD CONSTRAINT fk2aplicacaodaconta FOREIGN KEY (fkaplicfin) REFERENCES public.aplicacoesfinanceiras(pkaplicfin) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.areadeestudocursos ADD CONSTRAINT fk1areadeestcurso FOREIGN KEY (ukcecurso) REFERENCES public.cursos(pkcurso) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.areadeestudocursos ADD CONSTRAINT fk2areadeestcurso FOREIGN KEY (ukceareadeestudo) REFERENCES public.areadeestudos(pkareadeestudo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.areadeestudodisciplinas ADD CONSTRAINT fk1areadeestdiscipl FOREIGN KEY (ukcedisciplina) REFERENCES public.disciplinas(pkdisciplina) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.areadeestudodisciplinas ADD CONSTRAINT fk2areadeestdiscipl FOREIGN KEY (ukceareadeestudo) REFERENCES public.areadeestudos(pkareadeestudo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.areadeestudolivros ADD CONSTRAINT fk1areadeestlivro FOREIGN KEY (ukcelivro) REFERENCES public.livros(pklivro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.areadeestudolivros ADD CONSTRAINT fk2areadeestlivro FOREIGN KEY (ukceareadeestudo) REFERENCES public.areadeestudos(pkareadeestudo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.armazens ADD CONSTRAINT fk1armazem FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.armazens ADD CONSTRAINT fk2armazem FOREIGN KEY (fkcliente) REFERENCES public.clientes(pkcliente) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.armazenstels ADD CONSTRAINT fk1armazemtel FOREIGN KEY (fkarmazem) REFERENCES public.armazens(pkarmazem) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.armazenstels ADD CONSTRAINT fk2armazemtel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.atribuicoes ADD CONSTRAINT fk1atribuicao FOREIGN KEY (ukceprofessor) REFERENCES public.professores(pkprofessor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.atribuicoes ADD CONSTRAINT fk2atribuicao FOREIGN KEY (ukcedisciplina) REFERENCES public.disciplinas(pkdisciplina) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.atuacoes ADD CONSTRAINT fk1atuacao FOREIGN KEY (ukcetarefaprojeto) REFERENCES public.tarefasprojetos(pktarefaprojeto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.atuacoes ADD CONSTRAINT fk2atuacao FOREIGN KEY (ukcefuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.autores ADD CONSTRAINT fk1autor FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.autorestels ADD CONSTRAINT fk1autortel FOREIGN KEY (fkautor) REFERENCES public.autores(pkautor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.autorestels ADD CONSTRAINT fk2autortel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.autorias ADD CONSTRAINT fk1autoria FOREIGN KEY (ukcelivro) REFERENCES public.livros(pklivro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.autorias ADD CONSTRAINT fk2autoria FOREIGN KEY (ukceautor) REFERENCES public.autores(pkautor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.bairros ADD CONSTRAINT fk1bairro FOREIGN KEY (fkcidade) REFERENCES public.cidades(pkcidade) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.bairroslogradouros ADD CONSTRAINT fk1bairrologradouro FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.bairroslogradouros ADD CONSTRAINT fk2bairrologradouro FOREIGN KEY (fkbairro) REFERENCES public.bairros(pkbairro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.bancos ADD CONSTRAINT fk1banco FOREIGN KEY (fklogradourosede) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.bibliografias ADD CONSTRAINT fk1bibliografia FOREIGN KEY (ukcedisciplina) REFERENCES public.disciplinas(pkdisciplina) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.bibliografias ADD CONSTRAINT fk2bibliografia FOREIGN KEY (ukcelivro) REFERENCES public.livros(pklivro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.capacitacoes ADD CONSTRAINT fk1capacitacao FOREIGN KEY (fkcurso) REFERENCES public.cursos(pkcurso) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.capacitacoes ADD CONSTRAINT fk2capacitacao FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.cidades ADD CONSTRAINT fk1cidade FOREIGN KEY (fkestadodopais) REFERENCES public.estadosdospaises(pkestadodopais) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.clientes ADD CONSTRAINT fk1cliente FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.clientestels ADD CONSTRAINT fk1clientetel FOREIGN KEY (fkcliente) REFERENCES public.clientes(pkcliente) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.clientestels ADD CONSTRAINT fk2clientetel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.consultas ADD CONSTRAINT fk1consulta FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.consultas ADD CONSTRAINT fk2consulta FOREIGN KEY (fkmedico) REFERENCES public.medicos(pkmedico) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.consultas ADD CONSTRAINT fk3consulta FOREIGN KEY (fkplanodesaude) REFERENCES public.planosdesaude(pkplanodesaude) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.contas ADD CONSTRAINT fk1conta FOREIGN KEY (pkfkbanco,pkfkagencia) REFERENCES public.agencias(pkfkbanco,pkagencia) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.contas ADD CONSTRAINT fk2conta FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.departamentos ADD CONSTRAINT fk1depart FOREIGN KEY (fkfuncionariogerente) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.departamentos ADD CONSTRAINT fk2depart FOREIGN KEY (fkdeptosuperior) REFERENCES public.departamentos(pkdepto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.departamentostels ADD CONSTRAINT fk1departtel FOREIGN KEY (fkdepto) REFERENCES public.departamentos(pkdepto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.departamentostels ADD CONSTRAINT fk2departtel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.disciplinas ADD CONSTRAINT fk1disciplina FOREIGN KEY (fkcurso) REFERENCES public.cursos(pkcurso) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.duplicatas ADD CONSTRAINT fk1duplicata FOREIGN KEY (fknunfvenda) REFERENCES public.nfvendas(pknunfvenda) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.editoras ADD CONSTRAINT fk1editora FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.editorastels ADD CONSTRAINT fk1editoratel FOREIGN KEY (fkeditora) REFERENCES public.editoras(pkeditora) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.editorastels ADD CONSTRAINT fk2editoratel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.empresas ADD CONSTRAINT fk1empresa FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.empresastels ADD CONSTRAINT fk1empresatel FOREIGN KEY (fkempresa) REFERENCES public.empresas(pkempresa) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.empresastels ADD CONSTRAINT fk2empresatel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.estadosdospaises ADD CONSTRAINT fk1estadopais FOREIGN KEY (fkpais) REFERENCES public.paises(pkpais) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fabricantes ADD CONSTRAINT fk1fabricante FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fabricantes ADD CONSTRAINT fk2fabricante FOREIGN KEY (fksetoratuacao) REFERENCES public.setoresdeatuacao(pksetoratuacao) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fabricantestels ADD CONSTRAINT fk1fabricantetel FOREIGN KEY (fkfabricante) REFERENCES public.fabricantes(pkfabricante) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fabricantestels ADD CONSTRAINT fk2fabricantetel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.faturas ADD CONSTRAINT fk1fatura FOREIGN KEY (fknunfcompra) REFERENCES public.nfcompras(pknunfcompra) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fornecedores ADD CONSTRAINT fk1fornecedor FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fornecedorestels ADD CONSTRAINT fk1fornecedortel FOREIGN KEY (fkfornecedor) REFERENCES public.fornecedores(pkfornecedor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fornecedorestels ADD CONSTRAINT fk2fornecedortel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fornecimentos ADD CONSTRAINT fk1fornecimento FOREIGN KEY (ukceproduto) REFERENCES public.produtos(pkproduto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.fornecimentos ADD CONSTRAINT fk2fornecimento FOREIGN KEY (ukcefornecedor) REFERENCES public.fornecedores(pkfornecedor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionarios ADD CONSTRAINT fk1funcionario FOREIGN KEY (fkdepto) REFERENCES public.departamentos(pkdepto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionarios ADD CONSTRAINT fk2funcionario FOREIGN KEY (fkfuncao) REFERENCES public.funcoes(pkfuncao) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionarios ADD CONSTRAINT fk3funcionario FOREIGN KEY (fkgrauescolar) REFERENCES public.grausdeescolaridade(pkgrauescolar) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionarios ADD CONSTRAINT fk4funcionario FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionariosplanos ADD CONSTRAINT fk1funcionarioplano FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionariosplanos ADD CONSTRAINT fk2funcionarioplano FOREIGN KEY (fkplanodesaude) REFERENCES public.planosdesaude(pkplanodesaude) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionariostels ADD CONSTRAINT fk1funcionariotel FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.funcionariostels ADD CONSTRAINT fk2funcionariotel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.grausdeescolaridade ADD CONSTRAINT fk1grauescolar FOREIGN KEY (fkgrausprerequisitos) REFERENCES public.grausdeescolaridade(pkgrauescolar) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.habilitacoes ADD CONSTRAINT fk1habilitacao FOREIGN KEY (fkcurso) REFERENCES public.cursos(pkcurso) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.habilitacoes ADD CONSTRAINT fk2habilitacao FOREIGN KEY (fkprofessor) REFERENCES public.professores(pkprofessor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.historicoprofissional ADD CONSTRAINT fk1histprof FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.historicoprofissional ADD CONSTRAINT fk2histprof FOREIGN KEY (fkempresa) REFERENCES public.empresas(pkempresa) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.historicoprofissional ADD CONSTRAINT fk3histprof FOREIGN KEY (fkatividade) REFERENCES public.atividades(pkatividade) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.idiomasfalados ADD CONSTRAINT fk1idiomafalado FOREIGN KEY (fkidioma) REFERENCES public.idiomas(pkidioma) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.idiomasfalados ADD CONSTRAINT fk2idiomafalado FOREIGN KEY (fkpais) REFERENCES public.paises(pkpais) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.instituicoesdeensino ADD CONSTRAINT fk1instituicao FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.instituicoesdeensinotels ADD CONSTRAINT fk1instituicaotel FOREIGN KEY (fkinstituicao) REFERENCES public.instituicoesdeensino(pkinstituicao) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.instituicoesdeensinotels ADD CONSTRAINT fk2instituicaotel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.inventarios ADD CONSTRAINT fk1inventario FOREIGN KEY (ukceproduto) REFERENCES public.produtos(pkproduto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.inventarios ADD CONSTRAINT fk2inventario FOREIGN KEY (ukcefuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.livros ADD CONSTRAINT fk1livro FOREIGN KEY (fkeditora) REFERENCES public.editoras(pkeditora) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.logradouros ADD CONSTRAINT fk1logradouro FOREIGN KEY (fkcidade) REFERENCES public.cidades(pkcidade) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.logradouros ADD CONSTRAINT fk2logradouro FOREIGN KEY (fktipologradouro) REFERENCES public.logradourostipos(pktipologradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.matriculas ADD CONSTRAINT fk1matricula FOREIGN KEY (fkturma) REFERENCES public.turmas(pkturma) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.matriculas ADD CONSTRAINT fk2matricula FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.medicos ADD CONSTRAINT fk1medico FOREIGN KEY (fkespecialidade) REFERENCES public.especialidadesmedicas(pkespecialidade) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.medicos ADD CONSTRAINT fk2medico FOREIGN KEY (fkinstituicao) REFERENCES public.instituicoesdeensino(pkinstituicao) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.medicos ADD CONSTRAINT fk3medico FOREIGN KEY (fklogradouromoradia) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.medicos ADD CONSTRAINT fk4medico FOREIGN KEY (fklogradouroclinica) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.medicostels ADD CONSTRAINT fk1medicotel FOREIGN KEY (fkmedico) REFERENCES public.medicos(pkmedico) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.medicostels ADD CONSTRAINT fk2medicotel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.movimentos ADD CONSTRAINT fk1movimento FOREIGN KEY (fklivro) REFERENCES public.livros(pklivro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.movimentos ADD CONSTRAINT fk2movimento FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.movimentos ADD CONSTRAINT fk3movimento FOREIGN KEY (fktipomovimento) REFERENCES public.movimentostipos(pktipomovimento) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfcompras ADD CONSTRAINT fk1nfcompra FOREIGN KEY (fkfornecedor) REFERENCES public.fornecedores(pkfornecedor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfcompras ADD CONSTRAINT fk2nfcompra FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfcomprasitens ADD CONSTRAINT fk1nfcompraitem FOREIGN KEY (fknunfcompra) REFERENCES public.nfcompras(pknunfcompra) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfcomprasitens ADD CONSTRAINT fk2nfcompraitem FOREIGN KEY (fkproduto) REFERENCES public.produtos(pkproduto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfvendas ADD CONSTRAINT fk1nfvenda FOREIGN KEY (fkcliente) REFERENCES public.clientes(pkcliente) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfvendas ADD CONSTRAINT fk2nfvenda FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfvendas ADD CONSTRAINT fk3nfvenda FOREIGN KEY (fkarmazem) REFERENCES public.armazens(pkarmazem) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfvendasitens ADD CONSTRAINT fk1nfvendaitem FOREIGN KEY (fknunfvenda) REFERENCES public.nfvendas(pknunfvenda) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.nfvendasitens ADD CONSTRAINT fk2nfvendaitem FOREIGN KEY (fkproduto) REFERENCES public.produtos(pkproduto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.ocorrencias ADD CONSTRAINT fk1ocorrencia FOREIGN KEY (fksinistro) REFERENCES public.sinistros(pksinistro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.ocorrencias ADD CONSTRAINT fk2ocorrencia FOREIGN KEY (fkveiculo) REFERENCES public.veiculos(pkveiculo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.ocorrencias ADD CONSTRAINT fk3ocorrencia FOREIGN KEY (fknumeroapolice) REFERENCES public.seguros(pknumeroapolice) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.ocorrencias ADD CONSTRAINT fk4ocorrencia FOREIGN KEY (fklogradouroprincipal) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.ocorrencias ADD CONSTRAINT fk5ocorrencia FOREIGN KEY (fklogradourosecundario) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.oficinas ADD CONSTRAINT fk1oficina FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.oficinastels ADD CONSTRAINT fk1oficinatel FOREIGN KEY (fkoficina) REFERENCES public.oficinas(pkoficina) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.oficinastels ADD CONSTRAINT fk2oficinatel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.palavraslivros ADD CONSTRAINT fk1palavralivro FOREIGN KEY (fkpalavra) REFERENCES public.palavraschaves(pkpalavra) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.palavraslivros ADD CONSTRAINT fk2palavralivro FOREIGN KEY (fklivro) REFERENCES public.livros(pklivro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.passagens ADD CONSTRAINT fk1passagem FOREIGN KEY (fkviagem) REFERENCES public.viagens(pkviagem) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.passagens ADD CONSTRAINT fk2passagem FOREIGN KEY (fkonibus) REFERENCES public.veiculos(pkveiculo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.passagens ADD CONSTRAINT fk3passagem FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedcompras ADD CONSTRAINT fk1pedcompra FOREIGN KEY (fkfornecedor) REFERENCES public.fornecedores(pkfornecedor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedcompras ADD CONSTRAINT fk2pedcompra FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedcomprasitens ADD CONSTRAINT fk1pedcompraitem FOREIGN KEY (fkpedcompra) REFERENCES public.pedcompras(pkpedcompra) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedcomprasitens ADD CONSTRAINT fk2pedcompraitem FOREIGN KEY (fkproduto) REFERENCES public.produtos(pkproduto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedvendas ADD CONSTRAINT fk1pedvenda FOREIGN KEY (fkcliente) REFERENCES public.clientes(pkcliente) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedvendas ADD CONSTRAINT fk2pedvenda FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedvendasitens ADD CONSTRAINT fk1pedvendaitem FOREIGN KEY (fkpedvenda) REFERENCES public.pedvendas(pkpedvenda) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.pedvendasitens ADD CONSTRAINT fk2pedvendaitem FOREIGN KEY (fkproduto) REFERENCES public.produtos(pkproduto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.planosdesaude ADD CONSTRAINT fk1plansaude FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.planosdesaudemedicos ADD CONSTRAINT fk1plansaudemed FOREIGN KEY (fkplanodesaude) REFERENCES public.planosdesaude(pkplanodesaude) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.planosdesaudemedicos ADD CONSTRAINT fk2plansaudemed FOREIGN KEY (fkmedico) REFERENCES public.medicos(pkmedico) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.planosdesaudetels ADD CONSTRAINT fk1plansaudetel FOREIGN KEY (fkplanodesaude) REFERENCES public.planosdesaude(pkplanodesaude) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.planosdesaudetels ADD CONSTRAINT fk2plansaudetel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.professores ADD CONSTRAINT fk1professor FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.professorestels ADD CONSTRAINT fk1professortel FOREIGN KEY (fkprofessor) REFERENCES public.professores(pkprofessor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.professorestels ADD CONSTRAINT fk2professortel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.projetos ADD CONSTRAINT fk1projeto FOREIGN KEY (fkdepto) REFERENCES public.departamentos(pkdepto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.projetos ADD CONSTRAINT fk2projeto FOREIGN KEY (fkfuncresponsavel) REFERENCES public.funcionarios(pkfuncionario) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.projetos ADD CONSTRAINT fk3projeto FOREIGN KEY (fkprojetosuperior) REFERENCES public.projetos(pkprojeto) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.rotasviarias ADD CONSTRAINT fk1rotaviaria FOREIGN KEY (fkcidadeorigem) REFERENCES public.cidades(pkcidade) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.rotasviarias ADD CONSTRAINT fk2rotaviaria FOREIGN KEY (fkcidadedestino) REFERENCES public.cidades(pkcidade) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.roteiros ADD CONSTRAINT fk1roteiro FOREIGN KEY (fkrota) REFERENCES public.rotasviarias(pkrota) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.roteiros ADD CONSTRAINT fk2roteiro FOREIGN KEY (fkcidade) REFERENCES public.cidades(pkcidade) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.seguradoras ADD CONSTRAINT fk1seguradora FOREIGN KEY (fklogradouro) REFERENCES public.logradouros(pklogradouro) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.seguradorastels ADD CONSTRAINT fk1seguradoratel FOREIGN KEY (fkseguradora) REFERENCES public.seguradoras(pkseguradora) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.seguradorastels ADD CONSTRAINT fk2seguradoratel FOREIGN KEY (fkteltipo) REFERENCES public.telefonestipos(pkteltipo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.seguros ADD CONSTRAINT fk1seguro FOREIGN KEY (fkveiculo) REFERENCES public.veiculos(pkveiculo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.seguros ADD CONSTRAINT fk2seguro FOREIGN KEY (fkseguradora) REFERENCES public.seguradoras(pkseguradora) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.servicosfeitospor ADD CONSTRAINT fk1servicofeitopor FOREIGN KEY (fkoficina) REFERENCES public.oficinas(pkoficina) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.servicosfeitospor ADD CONSTRAINT fk2servicofeitopor FOREIGN KEY (fkservico) REFERENCES public.servicos(pkservico) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.servicosprestados ADD CONSTRAINT fk1servicoprestado FOREIGN KEY (fkservicofeitopor) REFERENCES public.servicosfeitospor(pkservicofeitopor) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.servicosprestados ADD CONSTRAINT fk2servicoprestado FOREIGN KEY (fkveiculo) REFERENCES public.veiculos(pkveiculo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.tarefasprojetos ADD CONSTRAINT fk1tarefaprojeto FOREIGN KEY (fkprojeto) REFERENCES public.projetos(pkprojeto) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.tarefasprojetos ADD CONSTRAINT fk2tarefaprojeto FOREIGN KEY (fktarefa) REFERENCES public.tarefas(pktarefa) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.titulacoes ADD CONSTRAINT fk1titulacao FOREIGN KEY (fkprofessor) REFERENCES public.professores(pkprofessor) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.titulacoes ADD CONSTRAINT fk2titulacao FOREIGN KEY (fkgrauescolar) REFERENCES public.grausdeescolaridade(pkgrauescolar) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.titulacoes ADD CONSTRAINT fk3titulacao FOREIGN KEY (fkinstituicao) REFERENCES public.instituicoesdeensino(pkinstituicao) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.turmas ADD CONSTRAINT fk1turma FOREIGN KEY (fkatribuicao) REFERENCES public.atribuicoes(pkatribuicao) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.veiculos ADD CONSTRAINT fk1veiculo FOREIGN KEY (fktipoveiculo) REFERENCES public.veiculostipos(pktipoveiculo) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.veiculos ADD CONSTRAINT fk2veiculo FOREIGN KEY (fkmodeloveiculo) REFERENCES public.veiculosmodelos(pkmodeloveiculo) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.veiculos ADD CONSTRAINT fk3veiculo FOREIGN KEY (fkfuncionario) REFERENCES public.funcionarios(pkfuncionario) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.veiculosmarcas ADD CONSTRAINT fk1veiculomarca FOREIGN KEY (fkfabricante) REFERENCES public.fabricantes(pkfabricante) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.veiculosmodelos ADD CONSTRAINT fk1veiculomodelo FOREIGN KEY (fkmarcaveiculo) REFERENCES public.veiculosmarcas(pkmarcaveiculo) MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE ONLY public.viagens ADD CONSTRAINT fk1viagem FOREIGN KEY (fkrota) REFERENCES public.rotasviarias(pkrota) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED;